...
func _() {
	...
	_ = x[PermissionDeliveryOrderCancel-56]
	_ = x[PermissionDeliveryOrderMarkCompleted-57]
	_ = x[PermissionDeliveryOrderDeliveryLocation-58]
	_ = x[PermissionDeliveryOrderDelete-59]
	_ = x[PermissionDeliveryOrderDeleteItem-60]
	_ = x[PermissionDeliveryOrderDeleteImage-61]
	_ = x[PermissionDeliveryOrderDeleteDriver-62]
	_ = x[PermissionProductCreate-63]
	_ = x[PermissionProductUpload-64]
	_ = x[PermissionProductFetch-65]
	_ = x[PermissionProductGet-66]
	_ = x[PermissionProductUpdate-67]
	_ = x[PermissionProductDelete-68]
	_ = x[PermissionProductOptionForProductReceiveItemForm-69]
	_ = x[PermissionProductOptionForDeliveryOrderItemForm-70]
	_ = x[PermissionProductOptionForCustomerTypeDiscountForm-71]
	_ = x[PermissionProductOptionForCartAddItemForm-72]
	_ = x[PermissionProductDiscountCreate-73]
	_ = x[PermissionProductDiscountUpdate-74]
	_ = x[PermissionProductDiscountDelete-75]
	_ = x[PermissionProductReceiveCreate-76]
	_ = x[PermissionProductReceiveUpload-77]
	_ = x[PermissionProductReceiveAddItem-78]
	_ = x[PermissionProductReceiveAddImage-79]
	_ = x[PermissionProductReceiveUpdate-80]
	_ = x[PermissionProductReceiveCancel-81]
	_ = x[PermissionProductReceiveMarkComplete-82]
	_ = x[PermissionProductReceiveFetch-83]
	_ = x[PermissionProductReceiveGet-84]
	_ = x[PermissionProductReceiveDelete-85]
	_ = x[PermissionProductReceiveDeleteItem-86]
	_ = x[PermissionProductReceiveDeleteImage-87]
	_ = x[PermissionProductStockFetch-88]
	_ = x[PermissionProductStockGet-89]
	_ = x[PermissionProductStockDownloadReport-90]
	_ = x[PermissionProductStockAdjustment-91]
	_ = x[PermissionProductUnitCreate-92]
	_ = x[PermissionProductUnitGet-93]
	_ = x[PermissionProductUnitUpdate-94]
	_ = x[PermissionProductUnitDelete-95]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-96]
	_ = x[PermissionProductUnitOptionForDeliveryOrderItemForm-97]
	_ = x[PermissionRoleOptionForUserForm-98]
	_ = x[PermissionShopOrderFetch-99]
	_ = x[PermissionShopOrderGet-100]
	_ = x[PermissionSsrWhatsappLogin-101]
	_ = x[PermissionSupplierCreate-102]
	_ = x[PermissionSupplierFetch-103]
	_ = x[PermissionSupplierGet-104]
	_ = x[PermissionSupplierUpdate-105]
	_ = x[PermissionSupplierDelete-106]
	_ = x[PermissionSupplierOptionForProductReceiveForm-107]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-108]
	_ = x[PermissionSupplierTypeCreate-109]
	_ = x[PermissionSupplierTypeFetch-110]
	_ = x[PermissionSupplierTypeGet-111]
	_ = x[PermissionSupplierTypeUpdate-112]
	_ = x[PermissionSupplierTypeDelete-113]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-114]
	_ = x[PermissionTiktokProductCreate-115]
	_ = x[PermissionTiktokProductUploadImage-116]
	_ = x[PermissionTiktokProductFetchBrands-117]
	_ = x[PermissionTiktokProductFetchCategories-118]
	_ = x[PermissionTiktokProductGetCategoryRules-119]
	_ = x[PermissionTiktokProductGetCategoryAttributes-120]
	_ = x[PermissionTiktokProductGet-121]
	_ = x[PermissionTiktokProductUpdate-122]
	_ = x[PermissionTiktokProductRecommendedCategory-123]
	_ = x[PermissionTiktokProductActivate-124]
	_ = x[PermissionTiktokProductDeactivate-125]
	_ = x[PermissionTransactionCheckoutCart-126]
	_ = x[PermissionTransactionGet-127]
	_ = x[PermissionUserCreate-128]
	_ = x[PermissionUserFetch-129]
	_ = x[PermissionUserGet-130]
	_ = x[PermissionUserUpdate-131]
	_ = x[PermissionUserUpdatePassword-132]
	_ = x[PermissionUserUpdateActive-133]
	_ = x[PermissionUserUpdateInActive-134]
	_ = x[PermissionUserAddRole-135]
	_ = x[PermissionUserDeleteRole-136]
	_ = x[PermissionUserOptionForCashierSessionFilter-137]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-138]
	_ = x[PermissionUnitCreate-139]
	_ = x[PermissionUnitFetch-140]
	_ = x[PermissionUnitGet-141]
	_ = x[PermissionUnitUpdate-142]
	_ = x[PermissionUnitDelete-143]
	_ = x[PermissionUnitOptionForProductUnitForm-144]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-145]
	_ = x[PermissionWhatsappIsLoggedIn-146]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-147]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-148]
	_ = x[PermissionWhatsappLogout-149]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 879, 889, 897, 909, 930, 951, 974, 998, 1023, 1043, 1070, 1088, 1120, 1147, 1172, 1193, 1222, 1254, 1275, 1301, 1328, 1356, 1370, 1384, 1397, 1408, 1422, 1436, 1480, 1523, 1569, 1606, 1629, 1652, 1675, 1697, 1719, 1743, 1768, 1790, 1812, 1841, 1862, 1881, 1903, 1930, 1958, 1977, 1994, 2023, 2047, 2066, 2082, 2101, 2120, 2169, 2217, 2242, 2258, 2272, 2290, 2305, 2319, 2331, 2346, 2361, 2401, 2443, 2463, 2482, 2499, 2519, 2539, 2577, 2598, 2625, 2652, 2683, 2707, 2745, 2763, 2784, 2819, 2854, 2891, 2916, 2931, 2942, 2952, 2960, 2971, 2991, 3009, 3029, 3042, 3058, 3096, 3138, 3149, 3159, 3167, 3178, 3189, 3222, 3263, 3284, 3323, 3364, 3379}
