...
func _() {
	...
	_ = x[PermissionProductReceiveReturned-91]
	...
	_ = x[PermissionProductStockAdjustmentFetch-97]
	...
	_ = x[PermissionPurchaseOrderCreate-108]
	_ = x[PermissionPurchaseOrderUpload-109]
	_ = x[PermissionPurchaseOrderAddItem-110]
	_ = x[PermissionPurchaseOrderAddImage-111]
	_ = x[PermissionPurchaseOrderUpdate-112]
	_ = x[PermissionPurchaseOrderCancel-113]
	_ = x[PermissionPurchaseOrderOngoing-114]
	_ = x[PermissionPurchaseOrderMarkComplete-115]
	_ = x[PermissionPurchaseOrderFetch-116]
	_ = x[PermissionPurchaseOrderGet-117]
	_ = x[PermissionPurchaseOrderDelete-118]
	_ = x[PermissionPurchaseOrderDeleteItem-119]
	_ = x[PermissionPurchaseOrderDeleteImage-120]
	_ = x[PermissionRoleOptionForUserForm-121]
	_ = x[PermissionShopOrderFetch-122]
	_ = x[PermissionShopOrderGet-123]
	_ = x[PermissionSsrWhatsappLogin-124]
	_ = x[PermissionSupplierCreate-125]
	_ = x[PermissionSupplierFetch-126]
	_ = x[PermissionSupplierGet-127]
	_ = x[PermissionSupplierUpdate-128]
	_ = x[PermissionSupplierDelete-129]
	_ = x[PermissionSupplierOptionForProductReceiveForm-130]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-131]
	_ = x[PermissionSupplierTypeCreate-132]
	_ = x[PermissionSupplierTypeFetch-133]
	_ = x[PermissionSupplierTypeGet-134]
	_ = x[PermissionSupplierTypeUpdate-135]
	_ = x[PermissionSupplierTypeDelete-136]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-137]
	_ = x[PermissionTiktokProductCreate-138]
	_ = x[PermissionTiktokProductUploadImage-139]
	_ = x[PermissionTiktokProductFetchBrands-140]
	_ = x[PermissionTiktokProductFetchCategories-141]
	_ = x[PermissionTiktokProductGetCategoryRules-142]
	_ = x[PermissionTiktokProductGetCategoryAttributes-143]
	_ = x[PermissionTiktokProductGet-144]
	_ = x[PermissionTiktokProductUpdate-145]
	_ = x[PermissionTiktokProductRecommendedCategory-146]
	_ = x[PermissionTiktokProductActivate-147]
	_ = x[PermissionTiktokProductDeactivate-148]
	_ = x[PermissionTransactionCheckoutCart-149]
	_ = x[PermissionTransactionGet-150]
	_ = x[PermissionUserCreate-151]
	_ = x[PermissionUserFetch-152]
	_ = x[PermissionUserGet-153]
	_ = x[PermissionUserUpdate-154]
	_ = x[PermissionUserUpdatePassword-155]
	_ = x[PermissionUserUpdateActive-156]
	_ = x[PermissionUserUpdateInActive-157]
	_ = x[PermissionUserAddRole-158]
	_ = x[PermissionUserDeleteRole-159]
	_ = x[PermissionUserOptionForCashierSessionFilter-160]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-161]
	_ = x[PermissionUserOptionForProductStockAdjustmentFilter-162]
	_ = x[PermissionUnitCreate-163]
	_ = x[PermissionUnitFetch-164]
	_ = x[PermissionUnitGet-165]
	_ = x[PermissionUnitUpdate-166]
	_ = x[PermissionUnitDelete-167]
	_ = x[PermissionUnitOptionForProductUnitForm-168]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-169]
	_ = x[PermissionWhatsappIsLoggedIn-170]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-171]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-172]
	_ = x[PermissionWhatsappLogout-173]
}

const _Permission_nameReadable = "BALANCE_CREATE, BALANCE_FETCH, BALANCE_GET, BALANCE_UPDATE, BALANCE_DELETE, CART_GET_ACTIVE, CART_ADD_ITEM, CART_UPDATE_ITEM, CART_DELETE_ITEM, CART_SET_ACTIVE, CART_SET_IN_ACTIVE, CART_DELETE, CASHIER_SESSION_FETCH, CASHIER_SESSION_START, CASHIER_SESSION_GET, CASHIER_SESSION_FETCH_TRANSACTION, CASHIER_SESSION_DOWNLOAD_REPORT, CASHIER_SESSION_GET_CURRENT, CASHIER_SESSION_END, CUSTOMER_CREATE, CUSTOMER_FETCH, CUSTOMER_GET, CUSTOMER_UPDATE, CUSTOMER_DELETE, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORM, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTER, CUSTOMER_DEBT_UPLOAD_IMAGE, CUSTOMER_DEBT_FETCH, CUSTOMER_DEBT_GET, CUSTOMER_DEBT_PAYMENT, CUSTOMER_TYPE_CREATE, CUSTOMER_TYPE_FETCH, CUSTOMER_TYPE_GET, CUSTOMER_TYPE_UPDATE, CUSTOMER_TYPE_DELETE, CUSTOMER_TYPE_ADD_DISCOUNT, CUSTOMER_TYPE_UPDATE_DISCOUNT, CUSTOMER_TYPE_DELETE_DISCOUNT, CUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORM, CUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORM, DASHBOARD_SUMMARIZE_DEBT, DASHBOARD_SUMMARIZE_TRANSACTION, DEBT_UPLOAD_IMAGE, DEBT_FETCH, DEBT_GET, DEBT_PAYMENT, DELIVERY_ORDER_CREATE, DELIVERY_ORDER_UPLOAD, DELIVERY_ORDER_ADD_ITEM, DELIVERY_ORDER_ADD_IMAGE, DELIVERY_ORDER_ADD_DRIVER, DELIVERY_ORDER_FETCH, DELIVERY_ORDER_FETCH_DRIVER, DELIVERY_ORDER_GET, DELIVERY_ORDER_ACTIVE_FOR_DRIVER, DELIVERY_ORDER_MARK_ONGOING, DELIVERY_ORDER_DELIVERING, DELIVERY_ORDER_UPDATE, DELIVERY_ORDER_CANCEL, DELIVERY_ORDER_MARK_COMPLETED, DELIVERY_ORDER_RETURNED, DELIVERY_ORDER_DELIVERY_LOCATION, DELIVERY_ORDER_DELETE, DELIVERY_ORDER_DELETE_ITEM, DELIVERY_ORDER_DELETE_IMAGE, DELIVERY_ORDER_DELETE_DRIVER, DELIVERY_ORDER_REVIEW_FETCH, DELIVERY_ORDER_REVIEW_GET, PRODUCT_CREATE, PRODUCT_UPLOAD, PRODUCT_FETCH, PRODUCT_GET, PRODUCT_UPDATE, PRODUCT_DELETE, PRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORM, PRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORM, PRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORM, PRODUCT_OPTION_FOR_CART_ADD_ITEM_FORM, PRODUCT_OPTION_FOR_PRODUCT_DISCOUNT_FORM, PRODUCT_DISCOUNT_CREATE, PRODUCT_DISCOUNT_FETCH, PRODUCT_DISCOUNT_GET, PRODUCT_DISCOUNT_UPDATE, PRODUCT_DISCOUNT_DELETE, PRODUCT_RECEIVE_CREATE, PRODUCT_RECEIVE_UPLOAD, PRODUCT_RECEIVE_ADD_IMAGE, PRODUCT_RECEIVE_UPDATE, PRODUCT_RECEIVE_CANCEL, PRODUCT_RECEIVE_MARK_COMPLETE, PRODUCT_RECEIVE_RETURNED, PRODUCT_RECEIVE_FETCH, PRODUCT_RECEIVE_GET, PRODUCT_RECEIVE_UPDATE_ITEM, PRODUCT_RECEIVE_DELETE, PRODUCT_RECEIVE_DELETE_IMAGE, PRODUCT_STOCK_ADJUSTMENT_FETCH, PRODUCT_STOCK_FETCH, PRODUCT_STOCK_GET, PRODUCT_STOCK_DOWNLOAD_REPORT, PRODUCT_STOCK_ADJUSTMENT, PRODUCT_UNIT_CREATE, PRODUCT_UNIT_GET, PRODUCT_UNIT_UPDATE, PRODUCT_UNIT_DELETE, PRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORM, PRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORM, PURCHASE_ORDER_CREATE, PURCHASE_ORDER_UPLOAD, PURCHASE_ORDER_ADD_ITEM, PURCHASE_ORDER_ADD_IMAGE, PURCHASE_ORDER_UPDATE, PURCHASE_ORDER_CANCEL, PURCHASE_ORDER_ONGOING, PURCHASE_ORDER_MARK_COMPLETE, PURCHASE_ORDER_FETCH, PURCHASE_ORDER_GET, PURCHASE_ORDER_DELETE, PURCHASE_ORDER_DELETE_ITEM, PURCHASE_ORDER_DELETE_IMAGE, ROLE_OPTION_FOR_USER_FORM, SHOP_ORDER_FETCH, SHOP_ORDER_GET, SSR_WHATSAPP_LOGIN, SUPPLIER_CREATE, SUPPLIER_FETCH, SUPPLIER_GET, SUPPLIER_UPDATE, SUPPLIER_DELETE, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORM, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTER, SUPPLIER_TYPE_CREATE, SUPPLIER_TYPE_FETCH, SUPPLIER_TYPE_GET, SUPPLIER_TYPE_UPDATE, SUPPLIER_TYPE_DELETE, SUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORM, TIKTOK_PRODUCT_CREATE, TIKTOK_PRODUCT_UPLOAD_IMAGE, TIKTOK_PRODUCT_FETCH_BRANDS, TIKTOK_PRODUCT_FETCH_CATEGORIES, TIKTOK_PRODUCT_GET_RULES, TIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTES, TIKTOK_PRODUCT_GET, TIKTOK_PRODUCT_UPDATE, TIKTOK_PRODUCT_RECOMMENDED_CATEGORY, TIKTOK_PRODUCT_RECOMMENDED_ACTIVATE, TIKTOK_PRODUCT_RECOMMENDED_DEACTIVATE, TRANSACTION_CHECKOUT_CART, TRANSACTION_GET, USER_CREATE, USER_FETCH, USER_GET, USER_UPDATE, USER_UPDATE_PASSWORD, USER_UPDATE_ACTIVE, USER_UPDATE_INACTIVE, USER_ADD_ROLE, USER_DELETE_ROLE, USER_OPTION_FOR_CASHIER_SESSION_FILTER, USER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORM, USER_OPTION_FOR_PRODUCT_STOCK_ADJUSTMENT_FILTER, UNIT_CREATE, UNIT_FETCH, UNIT_GET, UNIT_UPDATE, UNIT_DELETE, UNIT_OPTION_FOR_PRODUCT_UNIT_FORM, UNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORM, WHATSAPP_IS_LOGGED_IN, WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST, WHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCAST, WHATSAPP_LOGOUT"

const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDASHBOARD_SUMMARIZE_DEBTDASHBOARD_SUMMARIZE_TRANSACTIONDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_RETURNEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_OPTION_FOR_PRODUCT_DISCOUNT_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_FETCHPRODUCT_DISCOUNT_GETPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_RETURNEDPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_UPDATE_ITEMPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_ADJUSTMENT_FETCHPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPURCHASE_ORDER_CREATEPURCHASE_ORDER_UPLOADPURCHASE_ORDER_ADD_ITEMPURCHASE_ORDER_ADD_IMAGEPURCHASE_ORDER_UPDATEPURCHASE_ORDER_CANCELPURCHASE_ORDER_ONGOINGPURCHASE_ORDER_MARK_COMPLETEPURCHASE_ORDER_FETCHPURCHASE_ORDER_GETPURCHASE_ORDER_DELETEPURCHASE_ORDER_DELETE_ITEMPURCHASE_ORDER_DELETE_IMAGEROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUSER_OPTION_FOR_PRODUCT_STOCK_ADJUSTMENT_FILTERUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 886, 917, 934, 944, 952, 964, 985, 1006, 1029, 1053, 1078, 1098, 1125, 1143, 1175, 1202, 1227, 1248, 1269, 1298, 1321, 1353, 1374, 1400, 1427, 1455, 1482, 1507, 1521, 1535, 1548, 1559, 1573, 1587, 1631, 1674, 1720, 1757, 1797, 1820, 1842, 1862, 1885, 1908, 1930, 1952, 1977, 1999, 2021, 2050, 2074, 2095, 2114, 2141, 2163, 2191, 2221, 2240, 2257, 2286, 2310, 2329, 2345, 2364, 2383, 2432, 2480, 2501, 2522, 2545, 2569, 2590, 2611, 2633, 2661, 2681, 2699, 2720, 2746, 2773, 2798, 2814, 2828, 2846, 2861, 2875, 2887, 2902, 2917, 2957, 2999, 3019, 3038, 3055, 3075, 3095, 3133, 3154, 3181, 3208, 3239, 3263, 3301, 3319, 3340, 3375, 3410, 3447, 3472, 3487, 3498, 3508, 3516, 3527, 3547, 3565, 3585, 3598, 3614, 3652, 3694, 3741, 3752, 3762, 3770, 3781, 3792, 3825, 3866, 3887, 3926, 3967, 3982}
