...
func _() {
	...
	_ = x[PermissionDeliveryOrderCreate-31]
	_ = x[PermissionDeliveryOrderUpload-32]
	_ = x[PermissionDeliveryOrderAddItem-33]
	_ = x[PermissionDeliveryOrderAddImage-34]
	_ = x[PermissionDeliveryOrderAddDriver-35]
	_ = x[PermissionDeliveryOrderFetch-36]
	_ = x[PermissionDeliveryOrderGet-37]
	_ = x[PermissionDeliveryOrderMarkOngoing-38]
	_ = x[PermissionDeliveryOrderCancel-39]
	_ = x[PermissionDeliveryOrderMarkCompleted-40]
	_ = x[PermissionDeliveryOrderDelete-41]
	_ = x[PermissionDeliveryOrderDeleteItem-42]
	_ = x[PermissionDeliveryOrderDeleteImage-43]
	_ = x[PermissionDeliveryOrderDeleteDriver-44]
	_ = x[PermissionProductCreate-45]
	_ = x[PermissionProductUpload-46]
	_ = x[PermissionProductFetch-47]
	_ = x[PermissionProductGet-48]
	_ = x[PermissionProductUpdate-49]
	_ = x[PermissionProductDelete-50]
	_ = x[PermissionProductOptionForProductReceiveForm-51]
	_ = x[PermissionProductOptionForDeliveryOrderForm-52]
	_ = x[PermissionProductReceiveCreate-53]
	_ = x[PermissionProductReceiveUpload-54]
	_ = x[PermissionProductReceiveAddItem-55]
	_ = x[PermissionProductReceiveAddImage-56]
	_ = x[PermissionProductReceiveCancel-57]
	_ = x[PermissionProductReceiveMarkComplete-58]
	_ = x[PermissionProductReceiveFetch-59]
	_ = x[PermissionProductReceiveGet-60]
	_ = x[PermissionProductReceiveDelete-61]
	_ = x[PermissionProductReceiveDeleteItem-62]
	_ = x[PermissionProductReceiveDeleteImage-63]
	_ = x[PermissionProductStockFetch-64]
	_ = x[PermissionProductStockGet-65]
	_ = x[PermissionProductStockAdjustment-66]
	_ = x[PermissionProductUnitCreate-67]
	_ = x[PermissionProductUnitGet-68]
	_ = x[PermissionProductUnitUpdate-69]
	_ = x[PermissionProductUnitDelete-70]
	_ = x[PermissionProductUnitOptionForProductReceiveForm-71]
	_ = x[PermissionProductUnitOptionForDeliveryOrderForm-72]
	_ = x[PermissionRoleOptionForUserForm-73]
	_ = x[PermissionShopOrderFetch-74]
	_ = x[PermissionShopOrderGet-75]
	_ = x[PermissionSupplierCreate-76]
	_ = x[PermissionSupplierFetch-77]
	_ = x[PermissionSupplierGet-78]
	_ = x[PermissionSupplierUpdate-79]
	_ = x[PermissionSupplierDelete-80]
	_ = x[PermissionSupplierOptionForProductReceiveForm-81]
	_ = x[PermissionSupplierTypeCreate-82]
	_ = x[PermissionSupplierTypeFetch-83]
	_ = x[PermissionSupplierTypeGet-84]
	_ = x[PermissionSupplierTypeUpdate-85]
	_ = x[PermissionSupplierTypeDelete-86]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-87]
	_ = x[PermissionTiktokProductCreate-88]
	_ = x[PermissionTiktokProductUploadImage-89]
	_ = x[PermissionTiktokProductFetchBrands-90]
	_ = x[PermissionTiktokProductFetchCategories-91]
	_ = x[PermissionTiktokProductGetCategoryRules-92]
	_ = x[PermissionTiktokProductGetCategoryAttributes-93]
	_ = x[PermissionTiktokProductGet-94]
	_ = x[PermissionTiktokProductUpdate-95]
	_ = x[PermissionTiktokProductRecommendedCategory-96]
	_ = x[PermissionTiktokProductActivate-97]
	_ = x[PermissionTiktokProductDeactivate-98]
	_ = x[PermissionTransactionCheckoutCart-99]
	_ = x[PermissionUserCreate-100]
	_ = x[PermissionUserFetch-101]
	_ = x[PermissionUserGet-102]
	_ = x[PermissionUserUpdate-103]
	_ = x[PermissionUserUpdatePassword-104]
	_ = x[PermissionUserUpdateActive-105]
	_ = x[PermissionUserUpdateInActive-106]
	_ = x[PermissionUserAddRole-107]
	_ = x[PermissionUserDeleteRole-108]
	_ = x[PermissionUnitCreate-109]
	_ = x[PermissionUnitFetch-110]
	_ = x[PermissionUnitGet-111]
	_ = x[PermissionUnitUpdate-112]
	_ = x[PermissionUnitDelete-113]
	_ = x[PermissionUnitOptionForProductUnitForm-114]
}

const _Permission_nameReadable = "BALANCE_CREATE, BALANCE_FETCH, BALANCE_GET, BALANCE_UPDATE, BALANCE_DELETE, CART_GET_ACTIVE, CART_ADD_ITEM, CART_UPDATE_ITEM, CART_DELETE_ITEM, CART_SET_ACTIVE, CART_SET_IN_ACTIVE, CART_DELETE, CASHIER_SESSION_START, CASHIER_SESSION_GET_CURRENT, CASHIER_SESSION_END, CUSTOMER_CREATE, CUSTOMER_FETCH, CUSTOMER_GET, CUSTOMER_UPDATE, CUSTOMER_DELETE, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORM, CUSTOMER_DEBT_UPLOAD_IMAGE, CUSTOMER_DEBT_FETCH, CUSTOMER_DEBT_GET, CUSTOMER_DEBT_PAYMENT, CUSTOMER_TYPE_CREATE, CUSTOMER_TYPE_FETCH, CUSTOMER_TYPE_GET, CUSTOMER_TYPE_UPDATE, CUSTOMER_TYPE_DELETE, DELIVERY_ORDER_CREATE, DELIVERY_ORDER_UPLOAD, DELIVERY_ORDER_ADD_ITEM, DELIVERY_ORDER_ADD_IMAGE, DELIVERY_ORDER_ADD_DRIVER, DELIVERY_ORDER_FETCH, DELIVERY_ORDER_GET, DELIVERY_ORDER_MARK_ONGOING, DELIVERY_ORDER_CANCEL, DELIVERY_ORDER_MARK_COMPLETED, DELIVERY_ORDER_DELETE, DELIVERY_ORDER_DELETE_ITEM, DELIVERY_ORDER_DELETE_IMAGE, DELIVERY_ORDER_DELETE_DRIVER, PRODUCT_CREATE, PRODUCT_UPLOAD, PRODUCT_FETCH, PRODUCT_GET, PRODUCT_UPDATE, PRODUCT_DELETE, PRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORM, PRODUCT_OPTION_FOR_DELIVERY_ORDER_FORM, PRODUCT_RECEIVE_CREATE, PRODUCT_RECEIVE_UPLOAD, PRODUCT_RECEIVE_ADD_ITEM, PRODUCT_RECEIVE_ADD_IMAGE, PRODUCT_RECEIVE_CANCEL, PRODUCT_RECEIVE_MARK_COMPLETE, PRODUCT_RECEIVE_FETCH, PRODUCT_RECEIVE_GET, PRODUCT_RECEIVE_DELETE, PRODUCT_RECEIVE_DELETE_ITEM, PRODUCT_RECEIVE_DELETE_IMAGE, PRODUCT_STOCK_FETCH, PRODUCT_STOCK_GET, PRODUCT_STOCK_ADJUSTMENT, PRODUCT_UNIT_CREATE, PRODUCT_UNIT_GET, PRODUCT_UNIT_UPDATE, PRODUCT_UNIT_DELETE, PRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORM, PRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORM, ROLE_OPTION_FOR_USER_FORM, SHOP_ORDER_FETCH, SHOP_ORDER_GET, SUPPLIER_CREATE, SUPPLIER_FETCH, SUPPLIER_GET, SUPPLIER_UPDATE, SUPPLIER_DELETE, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORM, SUPPLIER_TYPE_CREATE, SUPPLIER_TYPE_FETCH, SUPPLIER_TYPE_GET, SUPPLIER_TYPE_UPDATE, SUPPLIER_TYPE_DELETE, SUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORM, TIKTOK_PRODUCT_CREATE, TIKTOK_PRODUCT_UPLOAD_IMAGE, TIKTOK_PRODUCT_FETCH_BRANDS, TIKTOK_PRODUCT_FETCH_CATEGORIES, TIKTOK_PRODUCT_GET_RULES, TIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTES, TIKTOK_PRODUCT_GET, TIKTOK_PRODUCT_UPDATE, TIKTOK_PRODUCT_RECOMMENDED_CATEGORY, TIKTOK_PRODUCT_RECOMMENDED_ACTIVATE, TIKTOK_PRODUCT_RECOMMENDED_DEACTIVATE, TRANSACTION_CHECKOUT_CART, USER_CREATE, USER_FETCH, USER_GET, USER_UPDATE, USER_UPDATE_PASSWORD, USER_UPDATE_ACTIVE, USER_UPDATE_INACTIVE, USER_ADD_ROLE, USER_DELETE_ROLE, UNIT_CREATE, UNIT_FETCH, UNIT_GET, UNIT_UPDATE, UNIT_DELETE, UNIT_OPTION_FOR_PRODUCT_UNIT_FORM"

const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_STARTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETEDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORM"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 218, 237, 252, 266, 278, 293, 308, 347, 373, 392, 409, 430, 450, 469, 486, 506, 526, 547, 568, 591, 615, 640, 660, 678, 705, 726, 755, 776, 802, 829, 857, 871, 885, 898, 909, 923, 937, 976, 1014, 1036, 1058, 1082, 1107, 1129, 1158, 1179, 1198, 1220, 1247, 1275, 1294, 1311, 1335, 1354, 1370, 1389, 1408, 1452, 1495, 1520, 1536, 1550, 1565, 1579, 1591, 1606, 1621, 1661, 1681, 1700, 1717, 1737, 1757, 1795, 1816, 1843, 1870, 1901, 1925, 1963, 1981, 2002, 2037, 2072, 2109, 2134, 2145, 2155, 2163, 2174, 2194, 2212, 2232, 2245, 2261, 2272, 2282, 2290, 2301, 2312, 2345}
