...
func _() {
	...
	_ = x[PermissionTransactionReprint-167]
	_ = x[PermissionUserCreate-168]
	_ = x[PermissionUserFetch-169]
	_ = x[PermissionUserGet-170]
	_ = x[PermissionUserUpdate-171]
	_ = x[PermissionUserUpdatePassword-172]
	_ = x[PermissionUserUpdateActive-173]
	_ = x[PermissionUserUpdateInActive-174]
	_ = x[PermissionUserAddRole-175]
	_ = x[PermissionUserDeleteRole-176]
	_ = x[PermissionUserOptionForCashierSessionFilter-177]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-178]
	_ = x[PermissionUserOptionForProductStockAdjustmentFilter-179]
	_ = x[PermissionUnitCreate-180]
	_ = x[PermissionUnitFetch-181]
	_ = x[PermissionUnitGet-182]
	_ = x[PermissionUnitUpdate-183]
	_ = x[PermissionUnitDelete-184]
	_ = x[PermissionUnitOptionForProductUnitForm-185]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-186]
	_ = x[PermissionWhatsappIsLoggedIn-187]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-188]
	_ = x[PermissionWhatsappCustomerDebtBroadcast-189]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-190]
	_ = x[PermissionWhatsappLogout-191]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_FETCH_FOR_CURRENT_USERCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_CUSTOMER_DEBT_REPORT_FORMCUSTOMER_OPTION_FOR_WHATSAPP_CUSTOMER_DEBT_BROADCAST_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_DOWNLOAD_REPORTCUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDASHBOARD_SUMMARIZE_DEBTDASHBOARD_SUMMARIZE_TRANSACTIONDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_DOWNLOAD_REPORTDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_DOWNLOAD_REPORTDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_RETURNEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_OPTION_FOR_PRODUCT_DISCOUNT_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_FETCHPRODUCT_DISCOUNT_GETPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_UPDATE_ITEMPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_RETURN_CREATEPRODUCT_RETURN_UPLOADPRODUCT_RETURN_ADD_ITEMPRODUCT_RETURN_ADD_IMAGEPRODUCT_RETURN_UPDATEPRODUCT_RETURN_CANCELPRODUCT_RETURN_MARK_COMPLETEPRODUCT_RETURN_FETCHPRODUCT_RETURN_GETPRODUCT_RETURN_DELETEPRODUCT_RETURN_DELETE_ITEMPRODUCT_RETURN_DELETE_IMAGEPRODUCT_STOCK_ADJUSTMENT_FETCHPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPURCHASE_ORDER_CREATEPURCHASE_ORDER_UPLOADPURCHASE_ORDER_ADD_ITEMPURCHASE_ORDER_ADD_IMAGEPURCHASE_ORDER_UPDATEPURCHASE_ORDER_CANCELPURCHASE_ORDER_ONGOINGPURCHASE_ORDER_MARK_COMPLETEPURCHASE_ORDER_FETCHPURCHASE_ORDER_GETPURCHASE_ORDER_DELETEPURCHASE_ORDER_DELETE_ITEMPURCHASE_ORDER_DELETE_IMAGEROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETTRANSACTION_REPRINTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUSER_OPTION_FOR_PRODUCT_STOCK_ADJUSTMENT_FILTERUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_DEBT_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 229, 250, 269, 302, 333, 360, 379, 394, 408, 420, 435, 450, 495, 552, 591, 632, 658, 687, 706, 723, 744, 764, 783, 800, 820, 840, 866, 895, 924, 962, 1031, 1055, 1086, 1103, 1113, 1133, 1141, 1153, 1174, 1204, 1225, 1248, 1272, 1297, 1317, 1344, 1362, 1394, 1421, 1446, 1467, 1488, 1517, 1540, 1572, 1593, 1619, 1646, 1674, 1701, 1726, 1740, 1754, 1767, 1778, 1792, 1806, 1850, 1893, 1939, 1976, 2016, 2039, 2061, 2081, 2104, 2127, 2149, 2174, 2196, 2218, 2247, 2268, 2287, 2314, 2336, 2364, 2385, 2406, 2429, 2453, 2474, 2495, 2523, 2543, 2561, 2582, 2608, 2635, 2665, 2684, 2701, 2730, 2754, 2773, 2789, 2808, 2827, 2876, 2924, 2945, 2966, 2989, 3013, 3034, 3055, 3077, 3105, 3125, 3143, 3164, 3190, 3217, 3242, 3258, 3272, 3290, 3305, 3319, 3331, 3346, 3361, 3401, 3443, 3463, 3482, 3499, 3519, 3539, 3577, 3598, 3625, 3652, 3683, 3707, 3745, 3763, 3784, 3819, 3854, 3891, 3916, 3931, 3950, 3961, 3971, 3979, 3990, 4010, 4028, 4048, 4061, 4077, 4115, 4157, 4204, 4215, 4225, 4233, 4244, 4255, 4288, 4329, 4350, 4389, 4421, 4462, 4477}
