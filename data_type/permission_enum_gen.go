...
func _() {
	...
	_ = x[PermissionDeliveryOrderReturned-59]
	_ = x[PermissionDeliveryOrderDeliveryLocation-60]
	_ = x[PermissionDeliveryOrderDelete-61]
	_ = x[PermissionDeliveryOrderDeleteItem-62]
	_ = x[PermissionDeliveryOrderDeleteImage-63]
	_ = x[PermissionDeliveryOrderDeleteDriver-64]
	_ = x[PermissionDeliveryOrderReviewFetch-65]
	_ = x[PermissionDeliveryOrderReviewGet-66]
	_ = x[PermissionProductCreate-67]
	_ = x[PermissionProductUpload-68]
	_ = x[PermissionProductFetch-69]
	_ = x[PermissionProductGet-70]
	_ = x[PermissionProductUpdate-71]
	_ = x[PermissionProductDelete-72]
	_ = x[PermissionProductOptionForProductReceiveItemForm-73]
	_ = x[PermissionProductOptionForDeliveryOrderItemForm-74]
	_ = x[PermissionProductOptionForCustomerTypeDiscountForm-75]
	_ = x[PermissionProductOptionForCartAddItemForm-76]
	_ = x[PermissionProductOptionForProductDiscountForm-77]
	_ = x[PermissionProductDiscountCreate-78]
	_ = x[PermissionProductDiscountFetch-79]
	_ = x[PermissionProductDiscountGet-80]
	_ = x[PermissionProductDiscountUpdate-81]
	_ = x[PermissionProductDiscountDelete-82]
	_ = x[PermissionProductReceiveCreate-83]
	_ = x[PermissionProductReceiveUpload-84]
	_ = x[PermissionProductReceiveAddItem-85]
	...
	_ = x[PermissionProductReceiveReturned-90]
	_ = x[PermissionProductReceiveFetch-91]
	_ = x[PermissionProductReceiveGet-92]
	_ = x[PermissionProductReceiveDelete-93]
	_ = x[PermissionProductReceiveDeleteItem-94]
	_ = x[PermissionProductReceiveDeleteImage-95]
	_ = x[PermissionProductStockFetch-96]
	_ = x[PermissionProductStockGet-97]
	_ = x[PermissionProductStockDownloadReport-98]
	_ = x[PermissionProductStockAdjustment-99]
	_ = x[PermissionProductUnitCreate-100]
	_ = x[PermissionProductUnitGet-101]
	_ = x[PermissionProductUnitUpdate-102]
	_ = x[PermissionProductUnitDelete-103]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-104]
	_ = x[PermissionProductUnitOptionForDeliveryOrderItemForm-105]
	_ = x[PermissionRoleOptionForUserForm-106]
	_ = x[PermissionShopOrderFetch-107]
	_ = x[PermissionShopOrderGet-108]
	_ = x[PermissionSsrWhatsappLogin-109]
	_ = x[PermissionSupplierCreate-110]
	_ = x[PermissionSupplierFetch-111]
	_ = x[PermissionSupplierGet-112]
	_ = x[PermissionSupplierUpdate-113]
	_ = x[PermissionSupplierDelete-114]
	_ = x[PermissionSupplierOptionForProductReceiveForm-115]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-116]
	_ = x[PermissionSupplierTypeCreate-117]
	_ = x[PermissionSupplierTypeFetch-118]
	_ = x[PermissionSupplierTypeGet-119]
	_ = x[PermissionSupplierTypeUpdate-120]
	_ = x[PermissionSupplierTypeDelete-121]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-122]
	_ = x[PermissionTiktokProductCreate-123]
	_ = x[PermissionTiktokProductUploadImage-124]
	_ = x[PermissionTiktokProductFetchBrands-125]
	_ = x[PermissionTiktokProductFetchCategories-126]
	_ = x[PermissionTiktokProductGetCategoryRules-127]
	_ = x[PermissionTiktokProductGetCategoryAttributes-128]
	_ = x[PermissionTiktokProductGet-129]
	_ = x[PermissionTiktokProductUpdate-130]
	_ = x[PermissionTiktokProductRecommendedCategory-131]
	_ = x[PermissionTiktokProductActivate-132]
	_ = x[PermissionTiktokProductDeactivate-133]
	_ = x[PermissionTransactionCheckoutCart-134]
	_ = x[PermissionTransactionGet-135]
	_ = x[PermissionUserCreate-136]
	_ = x[PermissionUserFetch-137]
	_ = x[PermissionUserGet-138]
	_ = x[PermissionUserUpdate-139]
	_ = x[PermissionUserUpdatePassword-140]
	_ = x[PermissionUserUpdateActive-141]
	_ = x[PermissionUserUpdateInActive-142]
	_ = x[PermissionUserAddRole-143]
	_ = x[PermissionUserDeleteRole-144]
	_ = x[PermissionUserOptionForCashierSessionFilter-145]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-146]
	_ = x[PermissionUnitCreate-147]
	_ = x[PermissionUnitFetch-148]
	_ = x[PermissionUnitGet-149]
	_ = x[PermissionUnitUpdate-150]
	_ = x[PermissionUnitDelete-151]
	_ = x[PermissionUnitOptionForProductUnitForm-152]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-153]
	_ = x[PermissionWhatsappIsLoggedIn-154]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-155]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-156]
	_ = x[PermissionWhatsappLogout-157]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_RETURNEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_OPTION_FOR_PRODUCT_DISCOUNT_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_FETCHPRODUCT_DISCOUNT_GETPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_RETURNEDPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 879, 889, 897, 909, 930, 951, 974, 998, 1023, 1043, 1070, 1088, 1120, 1147, 1172, 1193, 1214, 1243, 1266, 1298, 1319, 1345, 1372, 1400, 1427, 1452, 1466, 1480, 1493, 1504, 1518, 1532, 1576, 1619, 1665, 1702, 1742, 1765, 1787, 1807, 1830, 1853, 1875, 1897, 1921, 1946, 1968, 1990, 2019, 2043, 2064, 2083, 2105, 2132, 2160, 2179, 2196, 2225, 2249, 2268, 2284, 2303, 2322, 2371, 2419, 2444, 2460, 2474, 2492, 2507, 2521, 2533, 2548, 2563, 2603, 2645, 2665, 2684, 2701, 2721, 2741, 2779, 2800, 2827, 2854, 2885, 2909, 2947, 2965, 2986, 3021, 3056, 3093, 3118, 3133, 3144, 3154, 3162, 3173, 3193, 3211, 3231, 3244, 3260, 3298, 3340, 3351, 3361, 3369, 3380, 3391, 3424, 3465, 3486, 3525, 3566, 3581}
