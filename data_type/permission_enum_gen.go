...
func _() {
	...
	_ = x[PermissionDeliveryOrderCreate-41]
	_ = x[PermissionDeliveryOrderUpload-42]
	_ = x[PermissionDeliveryOrderAddItem-43]
	_ = x[PermissionDeliveryOrderAddImage-44]
	_ = x[PermissionDeliveryOrderAddDriver-45]
	_ = x[PermissionDeliveryOrderFetch-46]
	_ = x[PermissionDeliveryOrderFetchDriver-47]
	_ = x[PermissionDeliveryOrderGet-48]
	_ = x[PermissionDeliveryOrderActiveForDriver-49]
	_ = x[PermissionDeliveryOrderMarkOngoing-50]
	_ = x[PermissionDeliveryOrderDelivering-51]
	_ = x[PermissionDeliveryOrderCancel-52]
	_ = x[PermissionDeliveryOrderMarkCompleted-53]
	_ = x[PermissionDeliveryOrderDeliveryLocation-54]
	_ = x[PermissionDeliveryOrderDelete-55]
	_ = x[PermissionDeliveryOrderDeleteItem-56]
	_ = x[PermissionDeliveryOrderDeleteImage-57]
	_ = x[PermissionDeliveryOrderDeleteDriver-58]
	_ = x[PermissionProductCreate-59]
	_ = x[PermissionProductUpload-60]
	_ = x[PermissionProductFetch-61]
	_ = x[PermissionProductGet-62]
	_ = x[PermissionProductUpdate-63]
	_ = x[PermissionProductDelete-64]
	_ = x[PermissionProductOptionForProductReceiveItemForm-65]
	_ = x[PermissionProductOptionForDeliveryOrderItemForm-66]
	_ = x[PermissionProductOptionForCustomerTypeDiscountForm-67]
	_ = x[PermissionProductOptionForCartAddItemForm-68]
	_ = x[PermissionProductDiscountCreate-69]
	_ = x[PermissionProductDiscountUpdate-70]
	_ = x[PermissionProductDiscountDelete-71]
	_ = x[PermissionProductReceiveCreate-72]
	_ = x[PermissionProductReceiveUpload-73]
	_ = x[PermissionProductReceiveAddItem-74]
	_ = x[PermissionProductReceiveAddImage-75]
	_ = x[PermissionProductReceiveUpdate-76]
	_ = x[PermissionProductReceiveCancel-77]
	_ = x[PermissionProductReceiveMarkComplete-78]
	_ = x[PermissionProductReceiveFetch-79]
	_ = x[PermissionProductReceiveGet-80]
	_ = x[PermissionProductReceiveDelete-81]
	_ = x[PermissionProductReceiveDeleteItem-82]
	_ = x[PermissionProductReceiveDeleteImage-83]
	_ = x[PermissionProductStockFetch-84]
	_ = x[PermissionProductStockGet-85]
	_ = x[PermissionProductStockDownloadReport-86]
	_ = x[PermissionProductStockAdjustment-87]
	_ = x[PermissionProductUnitCreate-88]
	_ = x[PermissionProductUnitGet-89]
	_ = x[PermissionProductUnitUpdate-90]
	_ = x[PermissionProductUnitDelete-91]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-92]
	_ = x[PermissionProductUnitOptionForDeliveryOrderItemForm-93]
	_ = x[PermissionRoleOptionForUserForm-94]
	_ = x[PermissionShopOrderFetch-95]
	_ = x[PermissionShopOrderGet-96]
	_ = x[PermissionSsrWhatsappLogin-97]
	_ = x[PermissionSupplierCreate-98]
	_ = x[PermissionSupplierFetch-99]
	_ = x[PermissionSupplierGet-100]
	_ = x[PermissionSupplierUpdate-101]
	_ = x[PermissionSupplierDelete-102]
	_ = x[PermissionSupplierOptionForProductReceiveForm-103]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-104]
	_ = x[PermissionSupplierTypeCreate-105]
	_ = x[PermissionSupplierTypeFetch-106]
	_ = x[PermissionSupplierTypeGet-107]
	_ = x[PermissionSupplierTypeUpdate-108]
	_ = x[PermissionSupplierTypeDelete-109]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-110]
	_ = x[PermissionTiktokProductCreate-111]
	_ = x[PermissionTiktokProductUploadImage-112]
	_ = x[PermissionTiktokProductFetchBrands-113]
	_ = x[PermissionTiktokProductFetchCategories-114]
	_ = x[PermissionTiktokProductGetCategoryRules-115]
	_ = x[PermissionTiktokProductGetCategoryAttributes-116]
	_ = x[PermissionTiktokProductGet-117]
	_ = x[PermissionTiktokProductUpdate-118]
	_ = x[PermissionTiktokProductRecommendedCategory-119]
	_ = x[PermissionTiktokProductActivate-120]
	_ = x[PermissionTiktokProductDeactivate-121]
	_ = x[PermissionTransactionCheckoutCart-122]
	_ = x[PermissionTransactionGet-123]
	_ = x[PermissionUserCreate-124]
	_ = x[PermissionUserFetch-125]
	_ = x[PermissionUserGet-126]
	_ = x[PermissionUserUpdate-127]
	_ = x[PermissionUserUpdatePassword-128]
	_ = x[PermissionUserUpdateActive-129]
	_ = x[PermissionUserUpdateInActive-130]
	_ = x[PermissionUserAddRole-131]
	_ = x[PermissionUserDeleteRole-132]
	_ = x[PermissionUserOptionForCashierSessionFilter-133]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-134]
	_ = x[PermissionUnitCreate-135]
	_ = x[PermissionUnitFetch-136]
	_ = x[PermissionUnitGet-137]
	_ = x[PermissionUnitUpdate-138]
	_ = x[PermissionUnitDelete-139]
	_ = x[PermissionUnitOptionForProductUnitForm-140]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-141]
	_ = x[PermissionWhatsappIsLoggedIn-142]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-143]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-144]
	_ = x[PermissionWhatsappLogout-145]
}

const _Permission_nameReadable = "BALANCE_CREATE, BALANCE_FETCH, BALANCE_GET, BALANCE_UPDATE, BALANCE_DELETE, CART_GET_ACTIVE, CART_ADD_ITEM, CART_UPDATE_ITEM, CART_DELETE_ITEM, CART_SET_ACTIVE, CART_SET_IN_ACTIVE, CART_DELETE, CASHIER_SESSION_FETCH, CASHIER_SESSION_START, CASHIER_SESSION_GET, CASHIER_SESSION_FETCH_TRANSACTION, CASHIER_SESSION_DOWNLOAD_REPORT, CASHIER_SESSION_GET_CURRENT, CASHIER_SESSION_END, CUSTOMER_CREATE, CUSTOMER_FETCH, CUSTOMER_GET, CUSTOMER_UPDATE, CUSTOMER_DELETE, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORM, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTER, CUSTOMER_DEBT_UPLOAD_IMAGE, CUSTOMER_DEBT_FETCH, CUSTOMER_DEBT_GET, CUSTOMER_DEBT_PAYMENT, CUSTOMER_TYPE_CREATE, CUSTOMER_TYPE_FETCH, CUSTOMER_TYPE_GET, CUSTOMER_TYPE_UPDATE, CUSTOMER_TYPE_DELETE, CUSTOMER_TYPE_ADD_DISCOUNT, CUSTOMER_TYPE_UPDATE_DISCOUNT, CUSTOMER_TYPE_DELETE_DISCOUNT, CUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORM, CUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORM, DELIVERY_ORDER_CREATE, DELIVERY_ORDER_UPLOAD, DELIVERY_ORDER_ADD_ITEM, DELIVERY_ORDER_ADD_IMAGE, DELIVERY_ORDER_ADD_DRIVER, DELIVERY_ORDER_FETCH, DELIVERY_ORDER_FETCH_DRIVER, DELIVERY_ORDER_GET, DELIVERY_ORDER_ACTIVE_FOR_DRIVER, DELIVERY_ORDER_MARK_ONGOING, DELIVERY_ORDER_DELIVERING, DELIVERY_ORDER_CANCEL, DELIVERY_ORDER_MARK_COMPLETED, DELIVERY_ORDER_DELIVERY_LOCATION, DELIVERY_ORDER_DELETE, DELIVERY_ORDER_DELETE_ITEM, DELIVERY_ORDER_DELETE_IMAGE, DELIVERY_ORDER_DELETE_DRIVER, PRODUCT_CREATE, PRODUCT_UPLOAD, PRODUCT_FETCH, PRODUCT_GET, PRODUCT_UPDATE, PRODUCT_DELETE, PRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORM, PRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORM, PRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORM, PRODUCT_OPTION_FOR_CART_ADD_ITEM_FORM, PRODUCT_DISCOUNT_CREATE, PRODUCT_DISCOUNT_UPDATE, PRODUCT_DISCOUNT_DELETE, PRODUCT_RECEIVE_CREATE, PRODUCT_RECEIVE_UPLOAD, PRODUCT_RECEIVE_ADD_ITEM, PRODUCT_RECEIVE_ADD_IMAGE, PRODUCT_RECEIVE_UPDATE, PRODUCT_RECEIVE_CANCEL, PRODUCT_RECEIVE_MARK_COMPLETE, PRODUCT_RECEIVE_FETCH, PRODUCT_RECEIVE_GET, PRODUCT_RECEIVE_DELETE, PRODUCT_RECEIVE_DELETE_ITEM, PRODUCT_RECEIVE_DELETE_IMAGE, PRODUCT_STOCK_FETCH, PRODUCT_STOCK_GET, PRODUCT_STOCK_DOWNLOAD_REPORT, PRODUCT_STOCK_ADJUSTMENT, PRODUCT_UNIT_CREATE, PRODUCT_UNIT_GET, PRODUCT_UNIT_UPDATE, PRODUCT_UNIT_DELETE, PRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORM, PRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORM, ROLE_OPTION_FOR_USER_FORM, SHOP_ORDER_FETCH, SHOP_ORDER_GET, SSR_WHATSAPP_LOGIN, SUPPLIER_CREATE, SUPPLIER_FETCH, SUPPLIER_GET, SUPPLIER_UPDATE, SUPPLIER_DELETE, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORM, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTER, SUPPLIER_TYPE_CREATE, SUPPLIER_TYPE_FETCH, SUPPLIER_TYPE_GET, SUPPLIER_TYPE_UPDATE, SUPPLIER_TYPE_DELETE, SUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORM, TIKTOK_PRODUCT_CREATE, TIKTOK_PRODUCT_UPLOAD_IMAGE, TIKTOK_PRODUCT_FETCH_BRANDS, TIKTOK_PRODUCT_FETCH_CATEGORIES, TIKTOK_PRODUCT_GET_RULES, TIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTES, TIKTOK_PRODUCT_GET, TIKTOK_PRODUCT_UPDATE, TIKTOK_PRODUCT_RECOMMENDED_CATEGORY, TIKTOK_PRODUCT_RECOMMENDED_ACTIVATE, TIKTOK_PRODUCT_RECOMMENDED_DEACTIVATE, TRANSACTION_CHECKOUT_CART, TRANSACTION_GET, USER_CREATE, USER_FETCH, USER_GET, USER_UPDATE, USER_UPDATE_PASSWORD, USER_UPDATE_ACTIVE, USER_UPDATE_INACTIVE, USER_ADD_ROLE, USER_DELETE_ROLE, USER_OPTION_FOR_CASHIER_SESSION_FILTER, USER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORM, UNIT_CREATE, UNIT_FETCH, UNIT_GET, UNIT_UPDATE, UNIT_DELETE, UNIT_OPTION_FOR_PRODUCT_UNIT_FORM, UNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORM, WHATSAPP_IS_LOGGED_IN, WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST, WHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCAST, WHATSAPP_LOGOUT"

const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 883, 904, 927, 951, 976, 996, 1023, 1041, 1073, 1100, 1125, 1146, 1175, 1207, 1228, 1254, 1281, 1309, 1323, 1337, 1350, 1361, 1375, 1389, 1433, 1476, 1522, 1559, 1582, 1605, 1628, 1650, 1672, 1696, 1721, 1743, 1765, 1794, 1815, 1834, 1856, 1883, 1911, 1930, 1947, 1976, 2000, 2019, 2035, 2054, 2073, 2122, 2170, 2195, 2211, 2225, 2243, 2258, 2272, 2284, 2299, 2314, 2354, 2396, 2416, 2435, 2452, 2472, 2492, 2530, 2551, 2578, 2605, 2636, 2660, 2698, 2716, 2737, 2772, 2807, 2844, 2869, 2884, 2895, 2905, 2913, 2924, 2944, 2962, 2982, 2995, 3011, 3049, 3091, 3102, 3112, 3120, 3131, 3142, 3175, 3216, 3237, 3276, 3317, 3332}
