...
func _() {
	...
	_ = x[PermissionDeliveryOrderCreate-22]
	_ = x[PermissionDeliveryOrderUpload-23]
	_ = x[PermissionDeliveryOrderAddItem-24]
	_ = x[PermissionDeliveryOrderAddImage-25]
	_ = x[PermissionDeliveryOrderAddDriver-26]
	_ = x[PermissionDeliveryOrderFetch-27]
	_ = x[PermissionDeliveryOrderGet-28]
	_ = x[PermissionDeliveryOrderMarkOngoing-29]
	_ = x[PermissionDeliveryOrderCancel-30]
	_ = x[PermissionDeliveryOrderMarkCompleted-31]
	_ = x[PermissionDeliveryOrderDelete-32]
	_ = x[PermissionDeliveryOrderDeleteItem-33]
	_ = x[PermissionDeliveryOrderDeleteImage-34]
	_ = x[PermissionDeliveryOrderDeleteDriver-35]
	_ = x[PermissionProductCreate-36]
	_ = x[PermissionProductFetch-37]
	_ = x[PermissionProductGet-38]
	_ = x[PermissionProductUpdate-39]
	_ = x[PermissionProductDelete-40]
	_ = x[PermissionProductOptionForProductReceiveForm-41]
	_ = x[PermissionProductOptionForDeliveryOrderForm-42]
	_ = x[PermissionProductReceiveCreate-43]
	_ = x[PermissionProductReceiveUpload-44]
	_ = x[PermissionProductReceiveAddItem-45]
	_ = x[PermissionProductReceiveAddImage-46]
	_ = x[PermissionProductReceiveCancel-47]
	_ = x[PermissionProductReceiveMarkComplete-48]
	_ = x[PermissionProductReceiveFetch-49]
	_ = x[PermissionProductReceiveGet-50]
	_ = x[PermissionProductReceiveDelete-51]
	_ = x[PermissionProductReceiveDeleteItem-52]
	_ = x[PermissionProductReceiveDeleteImage-53]
	_ = x[PermissionProductStockFetch-54]
	_ = x[PermissionProductStockGet-55]
	_ = x[PermissionProductStockAdjustment-56]
	_ = x[PermissionProductUnitCreate-57]
	_ = x[PermissionProductUnitUpload-58]
	_ = x[PermissionProductUnitGet-59]
	_ = x[PermissionProductUnitUpdate-60]
	_ = x[PermissionProductUnitDelete-61]
	_ = x[PermissionProductUnitOptionForProductReceiveForm-62]
	_ = x[PermissionProductUnitOptionForDeliveryOrderForm-63]
	_ = x[PermissionRoleOptionForUserForm-64]
	_ = x[PermissionSupplierCreate-65]
	_ = x[PermissionSupplierFetch-66]
	_ = x[PermissionSupplierGet-67]
	_ = x[PermissionSupplierUpdate-68]
	_ = x[PermissionSupplierDelete-69]
	_ = x[PermissionSupplierOptionForProductReceiveForm-70]
	_ = x[PermissionSupplierTypeCreate-71]
	_ = x[PermissionSupplierTypeFetch-72]
	_ = x[PermissionSupplierTypeGet-73]
	_ = x[PermissionSupplierTypeUpdate-74]
	_ = x[PermissionSupplierTypeDelete-75]
	_ = x[PermissionUserCreate-76]
	_ = x[PermissionUserUpdate-77]
	_ = x[PermissionUserUpdatePassword-78]
	_ = x[PermissionUserUpdateActive-79]
	_ = x[PermissionUserUpdateInActive-80]
	_ = x[PermissionUserAddRole-81]
	_ = x[PermissionUserDeleteRole-82]
	_ = x[PermissionUnitCreate-83]
	_ = x[PermissionUnitFetch-84]
	_ = x[PermissionUnitGet-85]
	_ = x[PermissionUnitUpdate-86]
	_ = x[PermissionUnitDelete-87]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_STARTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_UPLOADPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETEUSER_CREATEUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETE"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 218, 237, 252, 266, 278, 293, 308, 347, 368, 389, 412, 436, 461, 481, 499, 526, 547, 576, 597, 623, 650, 678, 692, 705, 716, 730, 744, 783, 821, 843, 865, 889, 914, 936, 965, 986, 1005, 1027, 1054, 1082, 1101, 1118, 1142, 1161, 1180, 1196, 1215, 1234, 1278, 1321, 1346, 1361, 1375, 1387, 1402, 1417, 1457, 1477, 1496, 1513, 1533, 1553, 1564, 1575, 1595, 1613, 1633, 1646, 1662, 1673, 1683, 1691, 1702, 1713}
