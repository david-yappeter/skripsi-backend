...
func _() {
	...
	_ = x[PermissionProductReceiveCreate-57]
	_ = x[PermissionProductReceiveUpload-58]
	_ = x[PermissionProductReceiveAddItem-59]
	_ = x[PermissionProductReceiveAddImage-60]
	_ = x[PermissionProductReceiveCancel-61]
	_ = x[PermissionProductReceiveMarkComplete-62]
	_ = x[PermissionProductReceiveFetch-63]
	_ = x[PermissionProductReceiveGet-64]
	_ = x[PermissionProductReceiveDelete-65]
	_ = x[PermissionProductReceiveDeleteItem-66]
	_ = x[PermissionProductReceiveDeleteImage-67]
	_ = x[PermissionProductStockFetch-68]
	_ = x[PermissionProductStockGet-69]
	_ = x[PermissionProductStockAdjustment-70]
	_ = x[PermissionProductUnitCreate-71]
	_ = x[PermissionProductUnitGet-72]
	_ = x[PermissionProductUnitUpdate-73]
	_ = x[PermissionProductUnitDelete-74]
	_ = x[PermissionProductUnitOptionForProductReceiveForm-75]
	_ = x[PermissionProductUnitOptionForDeliveryOrderForm-76]
	_ = x[PermissionRoleOptionForUserForm-77]
	_ = x[PermissionShopOrderFetch-78]
	_ = x[PermissionShopOrderGet-79]
	_ = x[PermissionSupplierCreate-80]
	_ = x[PermissionSupplierFetch-81]
	_ = x[PermissionSupplierGet-82]
	_ = x[PermissionSupplierUpdate-83]
	_ = x[PermissionSupplierDelete-84]
	_ = x[PermissionSupplierOptionForProductReceiveForm-85]
	_ = x[PermissionSupplierTypeCreate-86]
	_ = x[PermissionSupplierTypeFetch-87]
	_ = x[PermissionSupplierTypeGet-88]
	_ = x[PermissionSupplierTypeUpdate-89]
	_ = x[PermissionSupplierTypeDelete-90]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-91]
	_ = x[PermissionTiktokProductCreate-92]
	_ = x[PermissionTiktokProductUploadImage-93]
	_ = x[PermissionTiktokProductFetchBrands-94]
	_ = x[PermissionTiktokProductFetchCategories-95]
	_ = x[PermissionTiktokProductGetCategoryRules-96]
	_ = x[PermissionTiktokProductGetCategoryAttributes-97]
	_ = x[PermissionTiktokProductGet-98]
	_ = x[PermissionTiktokProductUpdate-99]
	_ = x[PermissionTiktokProductRecommendedCategory-100]
	_ = x[PermissionTiktokProductActivate-101]
	_ = x[PermissionTiktokProductDeactivate-102]
	_ = x[PermissionTransactionCheckoutCart-103]
	_ = x[PermissionUserCreate-104]
	_ = x[PermissionUserFetch-105]
	_ = x[PermissionUserGet-106]
	_ = x[PermissionUserUpdate-107]
	_ = x[PermissionUserUpdatePassword-108]
	_ = x[PermissionUserUpdateActive-109]
	_ = x[PermissionUserUpdateInActive-110]
	_ = x[PermissionUserAddRole-111]
	_ = x[PermissionUserDeleteRole-112]
	_ = x[PermissionUnitCreate-113]
	_ = x[PermissionUnitFetch-114]
	_ = x[PermissionUnitGet-115]
	_ = x[PermissionUnitUpdate-116]
	_ = x[PermissionUnitDelete-117]
	_ = x[PermissionUnitOptionForProductUnitForm-118]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_STARTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_ADD_DISCOUNTCUSTOMER_TYPE_OPTION_UPDATE_DISCOUNTCUSTOMER_TYPE_OPTION_DELETE_DISCOUNTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORM"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 218, 237, 252, 266, 278, 293, 308, 347, 373, 392, 409, 430, 450, 469, 486, 506, 526, 564, 597, 633, 669, 690, 711, 734, 758, 783, 803, 821, 848, 869, 898, 919, 945, 972, 1000, 1014, 1028, 1041, 1052, 1066, 1080, 1119, 1157, 1179, 1201, 1225, 1250, 1272, 1301, 1322, 1341, 1363, 1390, 1418, 1437, 1454, 1478, 1497, 1513, 1532, 1551, 1595, 1638, 1663, 1679, 1693, 1708, 1722, 1734, 1749, 1764, 1804, 1824, 1843, 1860, 1880, 1900, 1938, 1959, 1986, 2013, 2044, 2068, 2106, 2124, 2145, 2180, 2215, 2252, 2277, 2288, 2298, 2306, 2317, 2337, 2355, 2375, 2388, 2404, 2415, 2425, 2433, 2444, 2455, 2488}
