...
func _() {
	...
	_ = x[PermissionProductDiscountCreate-61]
	_ = x[PermissionProductDiscountUpdate-62]
	_ = x[PermissionProductDiscountDelete-63]
	_ = x[PermissionProductReceiveCreate-64]
	_ = x[PermissionProductReceiveUpload-65]
	_ = x[PermissionProductReceiveAddItem-66]
	_ = x[PermissionProductReceiveAddImage-67]
	_ = x[PermissionProductReceiveCancel-68]
	_ = x[PermissionProductReceiveMarkComplete-69]
	_ = x[PermissionProductReceiveFetch-70]
	_ = x[PermissionProductReceiveGet-71]
	_ = x[PermissionProductReceiveDelete-72]
	_ = x[PermissionProductReceiveDeleteItem-73]
	_ = x[PermissionProductReceiveDeleteImage-74]
	_ = x[PermissionProductStockFetch-75]
	_ = x[PermissionProductStockGet-76]
	_ = x[PermissionProductStockDownloadReport-77]
	_ = x[PermissionProductStockAdjustment-78]
	_ = x[PermissionProductUnitCreate-79]
	_ = x[PermissionProductUnitGet-80]
	_ = x[PermissionProductUnitUpdate-81]
	_ = x[PermissionProductUnitDelete-82]
	_ = x[PermissionProductUnitOptionForProductReceiveForm-83]
	_ = x[PermissionProductUnitOptionForDeliveryOrderForm-84]
	_ = x[PermissionRoleOptionForUserForm-85]
	_ = x[PermissionShopOrderFetch-86]
	_ = x[PermissionShopOrderGet-87]
	_ = x[PermissionSupplierCreate-88]
	_ = x[PermissionSupplierFetch-89]
	_ = x[PermissionSupplierGet-90]
	_ = x[PermissionSupplierUpdate-91]
	_ = x[PermissionSupplierDelete-92]
	_ = x[PermissionSupplierOptionForProductReceiveForm-93]
	_ = x[PermissionSupplierTypeCreate-94]
	_ = x[PermissionSupplierTypeFetch-95]
	_ = x[PermissionSupplierTypeGet-96]
	_ = x[PermissionSupplierTypeUpdate-97]
	_ = x[PermissionSupplierTypeDelete-98]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-99]
	_ = x[PermissionTiktokProductCreate-100]
	_ = x[PermissionTiktokProductUploadImage-101]
	_ = x[PermissionTiktokProductFetchBrands-102]
	_ = x[PermissionTiktokProductFetchCategories-103]
	_ = x[PermissionTiktokProductGetCategoryRules-104]
	_ = x[PermissionTiktokProductGetCategoryAttributes-105]
	_ = x[PermissionTiktokProductGet-106]
	_ = x[PermissionTiktokProductUpdate-107]
	_ = x[PermissionTiktokProductRecommendedCategory-108]
	_ = x[PermissionTiktokProductActivate-109]
	_ = x[PermissionTiktokProductDeactivate-110]
	_ = x[PermissionTransactionCheckoutCart-111]
	_ = x[PermissionUserCreate-112]
	_ = x[PermissionUserFetch-113]
	_ = x[PermissionUserGet-114]
	_ = x[PermissionUserUpdate-115]
	_ = x[PermissionUserUpdatePassword-116]
	_ = x[PermissionUserUpdateActive-117]
	_ = x[PermissionUserUpdateInActive-118]
	_ = x[PermissionUserAddRole-119]
	_ = x[PermissionUserDeleteRole-120]
	_ = x[PermissionUnitCreate-121]
	_ = x[PermissionUnitFetch-122]
	_ = x[PermissionUnitGet-123]
	_ = x[PermissionUnitUpdate-124]
	_ = x[PermissionUnitDelete-125]
	_ = x[PermissionUnitOptionForProductUnitForm-126]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_ADD_DISCOUNTCUSTOMER_TYPE_OPTION_UPDATE_DISCOUNTCUSTOMER_TYPE_OPTION_DELETE_DISCOUNTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORM"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 262, 289, 308, 323, 337, 349, 364, 379, 418, 444, 463, 480, 501, 521, 540, 557, 577, 597, 635, 668, 704, 740, 761, 782, 805, 829, 854, 874, 892, 919, 940, 969, 990, 1016, 1043, 1071, 1085, 1099, 1112, 1123, 1137, 1151, 1190, 1228, 1265, 1288, 1311, 1334, 1356, 1378, 1402, 1427, 1449, 1478, 1499, 1518, 1540, 1567, 1595, 1614, 1631, 1660, 1684, 1703, 1719, 1738, 1757, 1801, 1844, 1869, 1885, 1899, 1914, 1928, 1940, 1955, 1970, 2010, 2030, 2049, 2066, 2086, 2106, 2144, 2165, 2192, 2219, 2250, 2274, 2312, 2330, 2351, 2386, 2421, 2458, 2483, 2494, 2504, 2512, 2523, 2543, 2561, 2581, 2594, 2610, 2621, 2631, 2639, 2650, 2661, 2694}
