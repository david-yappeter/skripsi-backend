...
func _() {
	...
	_ = x[PermissionShopOrderFetch-69]
	_ = x[PermissionShopOrderGet-70]
	_ = x[PermissionSupplierCreate-71]
	_ = x[PermissionSupplierFetch-72]
	_ = x[PermissionSupplierGet-73]
	_ = x[PermissionSupplierUpdate-74]
	_ = x[PermissionSupplierDelete-75]
	_ = x[PermissionSupplierOptionForProductReceiveForm-76]
	_ = x[PermissionSupplierTypeCreate-77]
	_ = x[PermissionSupplierTypeFetch-78]
	_ = x[PermissionSupplierTypeGet-79]
	_ = x[PermissionSupplierTypeUpdate-80]
	_ = x[PermissionSupplierTypeDelete-81]
	_ = x[PermissionTiktokProductCreate-82]
	_ = x[PermissionTiktokProductUploadImage-83]
	_ = x[PermissionTiktokProductFetchBrands-84]
	_ = x[PermissionTiktokProductFetchCategories-85]
	_ = x[PermissionTiktokProductGetCategoryRules-86]
	_ = x[PermissionTiktokProductGetCategoryAttributes-87]
	_ = x[PermissionTiktokProductGet-88]
	_ = x[PermissionTiktokProductUpdate-89]
	_ = x[PermissionTiktokProductRecommendedCategory-90]
	_ = x[PermissionTiktokProductActivate-91]
	_ = x[PermissionTiktokProductDeactivate-92]
	_ = x[PermissionTransactionCheckoutCart-93]
	_ = x[PermissionUserCreate-94]
	_ = x[PermissionUserFetch-95]
	_ = x[PermissionUserGet-96]
	_ = x[PermissionUserUpdate-97]
	_ = x[PermissionUserUpdatePassword-98]
	_ = x[PermissionUserUpdateActive-99]
	_ = x[PermissionUserUpdateInActive-100]
	_ = x[PermissionUserAddRole-101]
	_ = x[PermissionUserDeleteRole-102]
	_ = x[PermissionUnitCreate-103]
	_ = x[PermissionUnitFetch-104]
	_ = x[PermissionUnitGet-105]
	_ = x[PermissionUnitUpdate-106]
	_ = x[PermissionUnitDelete-107]
	_ = x[PermissionUnitOptionForProductUnitForm-108]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_STARTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETETIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORM"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 218, 237, 252, 266, 278, 293, 308, 347, 373, 392, 409, 430, 451, 472, 495, 519, 544, 564, 582, 609, 630, 659, 680, 706, 733, 761, 775, 789, 802, 813, 827, 841, 880, 918, 940, 962, 986, 1011, 1033, 1062, 1083, 1102, 1124, 1151, 1179, 1198, 1215, 1239, 1258, 1274, 1293, 1312, 1356, 1399, 1424, 1440, 1454, 1469, 1483, 1495, 1510, 1525, 1565, 1585, 1604, 1621, 1641, 1661, 1682, 1709, 1736, 1767, 1791, 1829, 1847, 1868, 1903, 1938, 1975, 2000, 2011, 2021, 2029, 2040, 2060, 2078, 2098, 2111, 2127, 2138, 2148, 2156, 2167, 2178, 2211}
