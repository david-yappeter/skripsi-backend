...
func _() {
	...
	_ = x[PermissionDeliveryOrderMarkOngoing-46]
	_ = x[PermissionDeliveryOrderDelivering-47]
	_ = x[PermissionDeliveryOrderCancel-48]
	_ = x[PermissionDeliveryOrderMarkCompleted-49]
	_ = x[PermissionDeliveryOrderDeliveryLocation-50]
	_ = x[PermissionDeliveryOrderDelete-51]
	_ = x[PermissionDeliveryOrderDeleteItem-52]
	_ = x[PermissionDeliveryOrderDeleteImage-53]
	_ = x[PermissionDeliveryOrderDeleteDriver-54]
	_ = x[PermissionProductCreate-55]
	_ = x[PermissionProductUpload-56]
	_ = x[PermissionProductFetch-57]
	_ = x[PermissionProductGet-58]
	_ = x[PermissionProductUpdate-59]
	_ = x[PermissionProductDelete-60]
	_ = x[PermissionProductOptionForProductReceiveItemForm-61]
	_ = x[PermissionProductOptionForDeliveryOrderForm-62]
	_ = x[PermissionProductOptionForCustomerTypeDiscountForm-63]
	_ = x[PermissionProductOptionForCartAddItemForm-64]
	_ = x[PermissionProductDiscountCreate-65]
	_ = x[PermissionProductDiscountUpdate-66]
	_ = x[PermissionProductDiscountDelete-67]
	_ = x[PermissionProductReceiveCreate-68]
	_ = x[PermissionProductReceiveUpload-69]
	_ = x[PermissionProductReceiveAddItem-70]
	_ = x[PermissionProductReceiveAddImage-71]
	_ = x[PermissionProductReceiveUpdate-72]
	_ = x[PermissionProductReceiveCancel-73]
	_ = x[PermissionProductReceiveMarkComplete-74]
	_ = x[PermissionProductReceiveFetch-75]
	_ = x[PermissionProductReceiveGet-76]
	_ = x[PermissionProductReceiveDelete-77]
	_ = x[PermissionProductReceiveDeleteItem-78]
	_ = x[PermissionProductReceiveDeleteImage-79]
	_ = x[PermissionProductStockFetch-80]
	_ = x[PermissionProductStockGet-81]
	_ = x[PermissionProductStockDownloadReport-82]
	_ = x[PermissionProductStockAdjustment-83]
	_ = x[PermissionProductUnitCreate-84]
	_ = x[PermissionProductUnitGet-85]
	_ = x[PermissionProductUnitUpdate-86]
	_ = x[PermissionProductUnitDelete-87]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-88]
	_ = x[PermissionProductUnitOptionForDeliveryOrderForm-89]
	_ = x[PermissionRoleOptionForUserForm-90]
	_ = x[PermissionShopOrderFetch-91]
	_ = x[PermissionShopOrderGet-92]
	_ = x[PermissionSupplierCreate-93]
	_ = x[PermissionSupplierFetch-94]
	_ = x[PermissionSupplierGet-95]
	_ = x[PermissionSupplierUpdate-96]
	_ = x[PermissionSupplierDelete-97]
	_ = x[PermissionSupplierOptionForProductReceiveForm-98]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-99]
	_ = x[PermissionSupplierTypeCreate-100]
	_ = x[PermissionSupplierTypeFetch-101]
	_ = x[PermissionSupplierTypeGet-102]
	_ = x[PermissionSupplierTypeUpdate-103]
	_ = x[PermissionSupplierTypeDelete-104]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-105]
	_ = x[PermissionTiktokProductCreate-106]
	_ = x[PermissionTiktokProductUploadImage-107]
	_ = x[PermissionTiktokProductFetchBrands-108]
	_ = x[PermissionTiktokProductFetchCategories-109]
	_ = x[PermissionTiktokProductGetCategoryRules-110]
	_ = x[PermissionTiktokProductGetCategoryAttributes-111]
	_ = x[PermissionTiktokProductGet-112]
	_ = x[PermissionTiktokProductUpdate-113]
	_ = x[PermissionTiktokProductRecommendedCategory-114]
	_ = x[PermissionTiktokProductActivate-115]
	_ = x[PermissionTiktokProductDeactivate-116]
	_ = x[PermissionTransactionCheckoutCart-117]
	_ = x[PermissionUserCreate-118]
	_ = x[PermissionUserFetch-119]
	_ = x[PermissionUserGet-120]
	_ = x[PermissionUserUpdate-121]
	_ = x[PermissionUserUpdatePassword-122]
	_ = x[PermissionUserUpdateActive-123]
	_ = x[PermissionUserUpdateInActive-124]
	_ = x[PermissionUserAddRole-125]
	_ = x[PermissionUserDeleteRole-126]
	_ = x[PermissionUserOptionForCashierSessionFilter-127]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-128]
	_ = x[PermissionUnitCreate-129]
	_ = x[PermissionUnitFetch-130]
	_ = x[PermissionUnitGet-131]
	_ = x[PermissionUnitUpdate-132]
	_ = x[PermissionUnitDelete-133]
	_ = x[PermissionUnitOptionForProductUnitForm-134]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-135]
}

const _Permission_nameReadable = "BALANCE_CREATE, BALANCE_FETCH, BALANCE_GET, BALANCE_UPDATE, BALANCE_DELETE, CART_GET_ACTIVE, CART_ADD_ITEM, CART_UPDATE_ITEM, CART_DELETE_ITEM, CART_SET_ACTIVE, CART_SET_IN_ACTIVE, CART_DELETE, CASHIER_SESSION_FETCH, CASHIER_SESSION_START, CASHIER_SESSION_GET, CASHIER_SESSION_DOWNLOAD_REPORT, CASHIER_SESSION_GET_CURRENT, CASHIER_SESSION_END, CUSTOMER_CREATE, CUSTOMER_FETCH, CUSTOMER_GET, CUSTOMER_UPDATE, CUSTOMER_DELETE, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORM, CUSTOMER_DEBT_UPLOAD_IMAGE, CUSTOMER_DEBT_FETCH, CUSTOMER_DEBT_GET, CUSTOMER_DEBT_PAYMENT, CUSTOMER_TYPE_CREATE, CUSTOMER_TYPE_FETCH, CUSTOMER_TYPE_GET, CUSTOMER_TYPE_UPDATE, CUSTOMER_TYPE_DELETE, CUSTOMER_TYPE_ADD_DISCOUNT, CUSTOMER_TYPE_UPDATE_DISCOUNT, CUSTOMER_TYPE_DELETE_DISCOUNT, CUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORM, DELIVERY_ORDER_CREATE, DELIVERY_ORDER_UPLOAD, DELIVERY_ORDER_ADD_ITEM, DELIVERY_ORDER_ADD_IMAGE, DELIVERY_ORDER_ADD_DRIVER, DELIVERY_ORDER_FETCH, DELIVERY_ORDER_FETCH_DRIVER, DELIVERY_ORDER_GET, DELIVERY_ORDER_MARK_ONGOING, DELIVERY_ORDER_DELIVERING, DELIVERY_ORDER_CANCEL, DELIVERY_ORDER_MARK_COMPLETED, DELIVERY_ORDER_DELIVERY_LOCATION, DELIVERY_ORDER_DELETE, DELIVERY_ORDER_DELETE_ITEM, DELIVERY_ORDER_DELETE_IMAGE, DELIVERY_ORDER_DELETE_DRIVER, PRODUCT_CREATE, PRODUCT_UPLOAD, PRODUCT_FETCH, PRODUCT_GET, PRODUCT_UPDATE, PRODUCT_DELETE, PRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORM, PRODUCT_OPTION_FOR_DELIVERY_ORDER_FORM, PRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORM, PRODUCT_OPTION_FOR_CART_ADD_ITEM_FORM, PRODUCT_DISCOUNT_CREATE, PRODUCT_DISCOUNT_UPDATE, PRODUCT_DISCOUNT_DELETE, PRODUCT_RECEIVE_CREATE, PRODUCT_RECEIVE_UPLOAD, PRODUCT_RECEIVE_ADD_ITEM, PRODUCT_RECEIVE_ADD_IMAGE, PRODUCT_RECEIVE_UPDATE, PRODUCT_RECEIVE_CANCEL, PRODUCT_RECEIVE_MARK_COMPLETE, PRODUCT_RECEIVE_FETCH, PRODUCT_RECEIVE_GET, PRODUCT_RECEIVE_DELETE, PRODUCT_RECEIVE_DELETE_ITEM, PRODUCT_RECEIVE_DELETE_IMAGE, PRODUCT_STOCK_FETCH, PRODUCT_STOCK_GET, PRODUCT_STOCK_DOWNLOAD_REPORT, PRODUCT_STOCK_ADJUSTMENT, PRODUCT_UNIT_CREATE, PRODUCT_UNIT_GET, PRODUCT_UNIT_UPDATE, PRODUCT_UNIT_DELETE, PRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORM, PRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORM, ROLE_OPTION_FOR_USER_FORM, SHOP_ORDER_FETCH, SHOP_ORDER_GET, SUPPLIER_CREATE, SUPPLIER_FETCH, SUPPLIER_GET, SUPPLIER_UPDATE, SUPPLIER_DELETE, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORM, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTER, SUPPLIER_TYPE_CREATE, SUPPLIER_TYPE_FETCH, SUPPLIER_TYPE_GET, SUPPLIER_TYPE_UPDATE, SUPPLIER_TYPE_DELETE, SUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORM, TIKTOK_PRODUCT_CREATE, TIKTOK_PRODUCT_UPLOAD_IMAGE, TIKTOK_PRODUCT_FETCH_BRANDS, TIKTOK_PRODUCT_FETCH_CATEGORIES, TIKTOK_PRODUCT_GET_RULES, TIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTES, TIKTOK_PRODUCT_GET, TIKTOK_PRODUCT_UPDATE, TIKTOK_PRODUCT_RECOMMENDED_CATEGORY, TIKTOK_PRODUCT_RECOMMENDED_ACTIVATE, TIKTOK_PRODUCT_RECOMMENDED_DEACTIVATE, TRANSACTION_CHECKOUT_CART, USER_CREATE, USER_FETCH, USER_GET, USER_UPDATE, USER_UPDATE_PASSWORD, USER_UPDATE_ACTIVE, USER_UPDATE_INACTIVE, USER_ADD_ROLE, USER_DELETE_ROLE, USER_OPTION_FOR_CASHIER_SESSION_FILTER, USER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORM, UNIT_CREATE, UNIT_FETCH, UNIT_GET, UNIT_UPDATE, UNIT_DELETE, UNIT_OPTION_FOR_PRODUCT_UNIT_FORM, UNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORM"

const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORM"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 262, 289, 308, 323, 337, 349, 364, 379, 418, 444, 463, 480, 501, 521, 540, 557, 577, 597, 623, 652, 681, 719, 740, 761, 784, 808, 833, 853, 880, 898, 925, 950, 971, 1000, 1032, 1053, 1079, 1106, 1134, 1148, 1162, 1175, 1186, 1200, 1214, 1258, 1296, 1342, 1379, 1402, 1425, 1448, 1470, 1492, 1516, 1541, 1563, 1585, 1614, 1635, 1654, 1676, 1703, 1731, 1750, 1767, 1796, 1820, 1839, 1855, 1874, 1893, 1942, 1985, 2010, 2026, 2040, 2055, 2069, 2081, 2096, 2111, 2151, 2193, 2213, 2232, 2249, 2269, 2289, 2327, 2348, 2375, 2402, 2433, 2457, 2495, 2513, 2534, 2569, 2604, 2641, 2666, 2677, 2687, 2695, 2706, 2726, 2744, 2764, 2777, 2793, 2831, 2873, 2884, 2894, 2902, 2913, 2924, 2957, 2998}
