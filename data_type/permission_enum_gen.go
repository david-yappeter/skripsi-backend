...
func _() {
	...
	_ = x[PermissionRoleOptionForUserForm-109]
	_ = x[PermissionShopOrderFetch-110]
	_ = x[PermissionShopOrderGet-111]
	_ = x[PermissionSsrWhatsappLogin-112]
	_ = x[PermissionSupplierCreate-113]
	_ = x[PermissionSupplierFetch-114]
	_ = x[PermissionSupplierGet-115]
	_ = x[PermissionSupplierUpdate-116]
	_ = x[PermissionSupplierDelete-117]
	_ = x[PermissionSupplierOptionForProductReceiveForm-118]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-119]
	_ = x[PermissionSupplierTypeCreate-120]
	_ = x[PermissionSupplierTypeFetch-121]
	_ = x[PermissionSupplierTypeGet-122]
	_ = x[PermissionSupplierTypeUpdate-123]
	_ = x[PermissionSupplierTypeDelete-124]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-125]
	_ = x[PermissionTiktokProductCreate-126]
	_ = x[PermissionTiktokProductUploadImage-127]
	_ = x[PermissionTiktokProductFetchBrands-128]
	_ = x[PermissionTiktokProductFetchCategories-129]
	_ = x[PermissionTiktokProductGetCategoryRules-130]
	_ = x[PermissionTiktokProductGetCategoryAttributes-131]
	_ = x[PermissionTiktokProductGet-132]
	_ = x[PermissionTiktokProductUpdate-133]
	_ = x[PermissionTiktokProductRecommendedCategory-134]
	_ = x[PermissionTiktokProductActivate-135]
	_ = x[PermissionTiktokProductDeactivate-136]
	_ = x[PermissionTransactionCheckoutCart-137]
	_ = x[PermissionTransactionGet-138]
	_ = x[PermissionUserCreate-139]
	_ = x[PermissionUserFetch-140]
	_ = x[PermissionUserGet-141]
	_ = x[PermissionUserUpdate-142]
	_ = x[PermissionUserUpdatePassword-143]
	_ = x[PermissionUserUpdateActive-144]
	_ = x[PermissionUserUpdateInActive-145]
	_ = x[PermissionUserAddRole-146]
	_ = x[PermissionUserDeleteRole-147]
	_ = x[PermissionUserOptionForCashierSessionFilter-148]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-149]
	_ = x[PermissionUserOptionForProductStockAdjustmentFilter-150]
	_ = x[PermissionUnitCreate-151]
	_ = x[PermissionUnitFetch-152]
	_ = x[PermissionUnitGet-153]
	_ = x[PermissionUnitUpdate-154]
	_ = x[PermissionUnitDelete-155]
	_ = x[PermissionUnitOptionForProductUnitForm-156]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-157]
	_ = x[PermissionWhatsappIsLoggedIn-158]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-159]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-160]
	_ = x[PermissionWhatsappLogout-161]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDASHBOARD_SUMMARIZE_DEBTDASHBOARD_SUMMARIZE_TRANSACTIONDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_RETURNEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_OPTION_FOR_PRODUCT_DISCOUNT_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_FETCHPRODUCT_DISCOUNT_GETPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_RETURNEDPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_ADJUSTMENT_FETCHPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUSER_OPTION_FOR_PRODUCT_STOCK_ADJUSTMENT_FILTERUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 886, 917, 934, 944, 952, 964, 985, 1006, 1029, 1053, 1078, 1098, 1125, 1143, 1175, 1202, 1227, 1248, 1269, 1298, 1321, 1353, 1374, 1400, 1427, 1455, 1482, 1507, 1521, 1535, 1548, 1559, 1573, 1587, 1631, 1674, 1720, 1757, 1797, 1820, 1842, 1862, 1885, 1908, 1930, 1952, 1976, 2001, 2023, 2045, 2074, 2098, 2119, 2138, 2160, 2187, 2215, 2245, 2264, 2281, 2310, 2334, 2353, 2369, 2388, 2407, 2456, 2504, 2529, 2545, 2559, 2577, 2592, 2606, 2618, 2633, 2648, 2688, 2730, 2750, 2769, 2786, 2806, 2826, 2864, 2885, 2912, 2939, 2970, 2994, 3032, 3050, 3071, 3106, 3141, 3178, 3203, 3218, 3229, 3239, 3247, 3258, 3278, 3296, 3316, 3329, 3345, 3383, 3425, 3472, 3483, 3493, 3501, 3512, 3523, 3556, 3597, 3618, 3657, 3698, 3713}
