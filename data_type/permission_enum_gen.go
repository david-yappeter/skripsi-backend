...
func _() {
	...
	_ = x[PermissionProductReceiveUpload-85]
	_ = x[PermissionProductReceiveAddImage-86]
	_ = x[PermissionProductReceiveUpdate-87]
	_ = x[PermissionProductReceiveCancel-88]
	_ = x[PermissionProductReceiveMarkComplete-89]
	_ = x[PermissionProductReceiveFetch-90]
	_ = x[PermissionProductReceiveGet-91]
	_ = x[PermissionProductReceiveUpdateItem-92]
	_ = x[PermissionProductReceiveDelete-93]
	_ = x[PermissionProductReceiveDeleteImage-94]
	_ = x[PermissionProductReturnCreate-95]
	_ = x[PermissionProductReturnUpload-96]
	_ = x[PermissionProductReturnAddItem-97]
	_ = x[PermissionProductReturnAddImage-98]
	_ = x[PermissionProductReturnUpdate-99]
	_ = x[PermissionProductReturnCancel-100]
	_ = x[PermissionProductReturnMarkComplete-101]
	_ = x[PermissionProductReturnFetch-102]
	_ = x[PermissionProductReturnGet-103]
	_ = x[PermissionProductReturnDelete-104]
	_ = x[PermissionProductReturnDeleteItem-105]
	_ = x[PermissionProductReturnDeleteImage-106]
	_ = x[PermissionProductStockAdjustmentFetch-107]
	_ = x[PermissionProductStockFetch-108]
	_ = x[PermissionProductStockGet-109]
	_ = x[PermissionProductStockDownloadReport-110]
	_ = x[PermissionProductStockAdjustment-111]
	_ = x[PermissionProductUnitCreate-112]
	_ = x[PermissionProductUnitGet-113]
	_ = x[PermissionProductUnitUpdate-114]
	_ = x[PermissionProductUnitDelete-115]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-116]
	_ = x[PermissionProductUnitOptionForDeliveryOrderItemForm-117]
	_ = x[PermissionPurchaseOrderCreate-118]
	_ = x[PermissionPurchaseOrderUpload-119]
	_ = x[PermissionPurchaseOrderAddItem-120]
	_ = x[PermissionPurchaseOrderAddImage-121]
	_ = x[PermissionPurchaseOrderUpdate-122]
	_ = x[PermissionPurchaseOrderCancel-123]
	_ = x[PermissionPurchaseOrderOngoing-124]
	_ = x[PermissionPurchaseOrderMarkComplete-125]
	_ = x[PermissionPurchaseOrderFetch-126]
	_ = x[PermissionPurchaseOrderGet-127]
	_ = x[PermissionPurchaseOrderDelete-128]
	_ = x[PermissionPurchaseOrderDeleteItem-129]
	_ = x[PermissionPurchaseOrderDeleteImage-130]
	_ = x[PermissionRoleOptionForUserForm-131]
	_ = x[PermissionShopOrderFetch-132]
	_ = x[PermissionShopOrderGet-133]
	_ = x[PermissionSsrWhatsappLogin-134]
	_ = x[PermissionSupplierCreate-135]
	_ = x[PermissionSupplierFetch-136]
	_ = x[PermissionSupplierGet-137]
	_ = x[PermissionSupplierUpdate-138]
	_ = x[PermissionSupplierDelete-139]
	_ = x[PermissionSupplierOptionForProductReceiveForm-140]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-141]
	_ = x[PermissionSupplierTypeCreate-142]
	_ = x[PermissionSupplierTypeFetch-143]
	_ = x[PermissionSupplierTypeGet-144]
	_ = x[PermissionSupplierTypeUpdate-145]
	_ = x[PermissionSupplierTypeDelete-146]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-147]
	_ = x[PermissionTiktokProductCreate-148]
	_ = x[PermissionTiktokProductUploadImage-149]
	_ = x[PermissionTiktokProductFetchBrands-150]
	_ = x[PermissionTiktokProductFetchCategories-151]
	_ = x[PermissionTiktokProductGetCategoryRules-152]
	_ = x[PermissionTiktokProductGetCategoryAttributes-153]
	_ = x[PermissionTiktokProductGet-154]
	_ = x[PermissionTiktokProductUpdate-155]
	_ = x[PermissionTiktokProductRecommendedCategory-156]
	_ = x[PermissionTiktokProductActivate-157]
	_ = x[PermissionTiktokProductDeactivate-158]
	_ = x[PermissionTransactionCheckoutCart-159]
	_ = x[PermissionTransactionGet-160]
	_ = x[PermissionUserCreate-161]
	_ = x[PermissionUserFetch-162]
	_ = x[PermissionUserGet-163]
	_ = x[PermissionUserUpdate-164]
	_ = x[PermissionUserUpdatePassword-165]
	_ = x[PermissionUserUpdateActive-166]
	_ = x[PermissionUserUpdateInActive-167]
	_ = x[PermissionUserAddRole-168]
	_ = x[PermissionUserDeleteRole-169]
	_ = x[PermissionUserOptionForCashierSessionFilter-170]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-171]
	_ = x[PermissionUserOptionForProductStockAdjustmentFilter-172]
	_ = x[PermissionUnitCreate-173]
	_ = x[PermissionUnitFetch-174]
	_ = x[PermissionUnitGet-175]
	_ = x[PermissionUnitUpdate-176]
	_ = x[PermissionUnitDelete-177]
	_ = x[PermissionUnitOptionForProductUnitForm-178]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-179]
	_ = x[PermissionWhatsappIsLoggedIn-180]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-181]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-182]
	_ = x[PermissionWhatsappLogout-183]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDASHBOARD_SUMMARIZE_DEBTDASHBOARD_SUMMARIZE_TRANSACTIONDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_RETURNEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_OPTION_FOR_PRODUCT_DISCOUNT_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_FETCHPRODUCT_DISCOUNT_GETPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_UPDATE_ITEMPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_RETURN_CREATEPRODUCT_RETURN_UPLOADPRODUCT_RETURN_ADD_ITEMPRODUCT_RETURN_ADD_IMAGEPRODUCT_RETURN_UPDATEPRODUCT_RETURN_CANCELPRODUCT_RETURN_MARK_COMPLETEPRODUCT_RETURN_FETCHPRODUCT_RETURN_GETPRODUCT_RETURN_DELETEPRODUCT_RETURN_DELETE_ITEMPRODUCT_RETURN_DELETE_IMAGEPRODUCT_STOCK_ADJUSTMENT_FETCHPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPURCHASE_ORDER_CREATEPURCHASE_ORDER_UPLOADPURCHASE_ORDER_ADD_ITEMPURCHASE_ORDER_ADD_IMAGEPURCHASE_ORDER_UPDATEPURCHASE_ORDER_CANCELPURCHASE_ORDER_ONGOINGPURCHASE_ORDER_MARK_COMPLETEPURCHASE_ORDER_FETCHPURCHASE_ORDER_GETPURCHASE_ORDER_DELETEPURCHASE_ORDER_DELETE_ITEMPURCHASE_ORDER_DELETE_IMAGEROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUSER_OPTION_FOR_PRODUCT_STOCK_ADJUSTMENT_FILTERUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 886, 917, 934, 944, 952, 964, 985, 1006, 1029, 1053, 1078, 1098, 1125, 1143, 1175, 1202, 1227, 1248, 1269, 1298, 1321, 1353, 1374, 1400, 1427, 1455, 1482, 1507, 1521, 1535, 1548, 1559, 1573, 1587, 1631, 1674, 1720, 1757, 1797, 1820, 1842, 1862, 1885, 1908, 1930, 1955, 1977, 1999, 2028, 2049, 2068, 2095, 2117, 2145, 2166, 2187, 2210, 2234, 2255, 2276, 2304, 2324, 2342, 2363, 2389, 2416, 2446, 2465, 2482, 2511, 2535, 2554, 2570, 2589, 2608, 2657, 2705, 2726, 2747, 2770, 2794, 2815, 2836, 2858, 2886, 2906, 2924, 2945, 2971, 2998, 3023, 3039, 3053, 3071, 3086, 3100, 3112, 3127, 3142, 3182, 3224, 3244, 3263, 3280, 3300, 3320, 3358, 3379, 3406, 3433, 3464, 3488, 3526, 3544, 3565, 3600, 3635, 3672, 3697, 3712, 3723, 3733, 3741, 3752, 3772, 3790, 3810, 3823, 3839, 3877, 3919, 3966, 3977, 3987, 3995, 4006, 4017, 4050, 4091, 4112, 4151, 4192, 4207}
