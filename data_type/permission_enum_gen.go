...
func _() {
	...
	_ = x[PermissionSupplierTypeCreate-97]
	_ = x[PermissionSupplierTypeFetch-98]
	_ = x[PermissionSupplierTypeGet-99]
	_ = x[PermissionSupplierTypeUpdate-100]
	_ = x[PermissionSupplierTypeDelete-101]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-102]
	_ = x[PermissionTiktokProductCreate-103]
	_ = x[PermissionTiktokProductUploadImage-104]
	_ = x[PermissionTiktokProductFetchBrands-105]
	_ = x[PermissionTiktokProductFetchCategories-106]
	_ = x[PermissionTiktokProductGetCategoryRules-107]
	_ = x[PermissionTiktokProductGetCategoryAttributes-108]
	_ = x[PermissionTiktokProductGet-109]
	_ = x[PermissionTiktokProductUpdate-110]
	_ = x[PermissionTiktokProductRecommendedCategory-111]
	_ = x[PermissionTiktokProductActivate-112]
	_ = x[PermissionTiktokProductDeactivate-113]
	_ = x[PermissionTransactionCheckoutCart-114]
	_ = x[PermissionUserCreate-115]
	_ = x[PermissionUserFetch-116]
	_ = x[PermissionUserGet-117]
	_ = x[PermissionUserUpdate-118]
	_ = x[PermissionUserUpdatePassword-119]
	_ = x[PermissionUserUpdateActive-120]
	_ = x[PermissionUserUpdateInActive-121]
	_ = x[PermissionUserAddRole-122]
	_ = x[PermissionUserDeleteRole-123]
	_ = x[PermissionUserOptionForCashierSessionFilter-124]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-125]
	_ = x[PermissionUnitCreate-126]
	_ = x[PermissionUnitFetch-127]
	_ = x[PermissionUnitGet-128]
	_ = x[PermissionUnitUpdate-129]
	_ = x[PermissionUnitDelete-130]
	_ = x[PermissionUnitOptionForProductUnitForm-131]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-132]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORM"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 262, 289, 308, 323, 337, 349, 364, 379, 418, 444, 463, 480, 501, 521, 540, 557, 577, 597, 623, 652, 681, 719, 740, 761, 784, 808, 833, 853, 871, 898, 919, 948, 980, 1001, 1027, 1054, 1082, 1096, 1110, 1123, 1134, 1148, 1162, 1201, 1239, 1285, 1322, 1345, 1368, 1391, 1413, 1435, 1459, 1484, 1506, 1528, 1557, 1578, 1597, 1619, 1646, 1674, 1693, 1710, 1739, 1763, 1782, 1798, 1817, 1836, 1880, 1923, 1948, 1964, 1978, 1993, 2007, 2019, 2034, 2049, 2089, 2109, 2128, 2145, 2165, 2185, 2223, 2244, 2271, 2298, 2329, 2353, 2391, 2409, 2430, 2465, 2500, 2537, 2562, 2573, 2583, 2591, 2602, 2622, 2640, 2660, 2673, 2689, 2727, 2769, 2780, 2790, 2798, 2809, 2820, 2853, 2894}
