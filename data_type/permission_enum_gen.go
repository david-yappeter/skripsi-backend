...
func _() {
	...
	_ = x[PermissionProductDiscountCreate-76]
	_ = x[PermissionProductDiscountFetch-77]
	_ = x[PermissionProductDiscountGet-78]
	_ = x[PermissionProductDiscountUpdate-79]
	_ = x[PermissionProductDiscountDelete-80]
	_ = x[PermissionProductReceiveCreate-81]
	_ = x[PermissionProductReceiveUpload-82]
	_ = x[PermissionProductReceiveAddItem-83]
	_ = x[PermissionProductReceiveAddImage-84]
	_ = x[PermissionProductReceiveUpdate-85]
	_ = x[PermissionProductReceiveCancel-86]
	_ = x[PermissionProductReceiveMarkComplete-87]
	_ = x[PermissionProductReceiveFetch-88]
	_ = x[PermissionProductReceiveGet-89]
	_ = x[PermissionProductReceiveDelete-90]
	_ = x[PermissionProductReceiveDeleteItem-91]
	_ = x[PermissionProductReceiveDeleteImage-92]
	_ = x[PermissionProductStockFetch-93]
	_ = x[PermissionProductStockGet-94]
	_ = x[PermissionProductStockDownloadReport-95]
	_ = x[PermissionProductStockAdjustment-96]
	_ = x[PermissionProductUnitCreate-97]
	_ = x[PermissionProductUnitGet-98]
	_ = x[PermissionProductUnitUpdate-99]
	_ = x[PermissionProductUnitDelete-100]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-101]
	_ = x[PermissionProductUnitOptionForDeliveryOrderItemForm-102]
	_ = x[PermissionRoleOptionForUserForm-103]
	_ = x[PermissionShopOrderFetch-104]
	_ = x[PermissionShopOrderGet-105]
	_ = x[PermissionSsrWhatsappLogin-106]
	_ = x[PermissionSupplierCreate-107]
	_ = x[PermissionSupplierFetch-108]
	_ = x[PermissionSupplierGet-109]
	_ = x[PermissionSupplierUpdate-110]
	_ = x[PermissionSupplierDelete-111]
	_ = x[PermissionSupplierOptionForProductReceiveForm-112]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-113]
	_ = x[PermissionSupplierTypeCreate-114]
	_ = x[PermissionSupplierTypeFetch-115]
	_ = x[PermissionSupplierTypeGet-116]
	_ = x[PermissionSupplierTypeUpdate-117]
	_ = x[PermissionSupplierTypeDelete-118]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-119]
	_ = x[PermissionTiktokProductCreate-120]
	_ = x[PermissionTiktokProductUploadImage-121]
	_ = x[PermissionTiktokProductFetchBrands-122]
	_ = x[PermissionTiktokProductFetchCategories-123]
	_ = x[PermissionTiktokProductGetCategoryRules-124]
	_ = x[PermissionTiktokProductGetCategoryAttributes-125]
	_ = x[PermissionTiktokProductGet-126]
	_ = x[PermissionTiktokProductUpdate-127]
	_ = x[PermissionTiktokProductRecommendedCategory-128]
	_ = x[PermissionTiktokProductActivate-129]
	_ = x[PermissionTiktokProductDeactivate-130]
	_ = x[PermissionTransactionCheckoutCart-131]
	_ = x[PermissionTransactionGet-132]
	_ = x[PermissionUserCreate-133]
	_ = x[PermissionUserFetch-134]
	_ = x[PermissionUserGet-135]
	_ = x[PermissionUserUpdate-136]
	_ = x[PermissionUserUpdatePassword-137]
	_ = x[PermissionUserUpdateActive-138]
	_ = x[PermissionUserUpdateInActive-139]
	_ = x[PermissionUserAddRole-140]
	_ = x[PermissionUserDeleteRole-141]
	_ = x[PermissionUserOptionForCashierSessionFilter-142]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-143]
	_ = x[PermissionUnitCreate-144]
	_ = x[PermissionUnitFetch-145]
	_ = x[PermissionUnitGet-146]
	_ = x[PermissionUnitUpdate-147]
	_ = x[PermissionUnitDelete-148]
	_ = x[PermissionUnitOptionForProductUnitForm-149]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-150]
	_ = x[PermissionWhatsappIsLoggedIn-151]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-152]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-153]
	_ = x[PermissionWhatsappLogout-154]
}

const _Permission_nameReadable = "BALANCE_CREATE, BALANCE_FETCH, BALANCE_GET, BALANCE_UPDATE, BALANCE_DELETE, CART_GET_ACTIVE, CART_ADD_ITEM, CART_UPDATE_ITEM, CART_DELETE_ITEM, CART_SET_ACTIVE, CART_SET_IN_ACTIVE, CART_DELETE, CASHIER_SESSION_FETCH, CASHIER_SESSION_START, CASHIER_SESSION_GET, CASHIER_SESSION_FETCH_TRANSACTION, CASHIER_SESSION_DOWNLOAD_REPORT, CASHIER_SESSION_GET_CURRENT, CASHIER_SESSION_END, CUSTOMER_CREATE, CUSTOMER_FETCH, CUSTOMER_GET, CUSTOMER_UPDATE, CUSTOMER_DELETE, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORM, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTER, CUSTOMER_DEBT_UPLOAD_IMAGE, CUSTOMER_DEBT_FETCH, CUSTOMER_DEBT_GET, CUSTOMER_DEBT_PAYMENT, CUSTOMER_TYPE_CREATE, CUSTOMER_TYPE_FETCH, CUSTOMER_TYPE_GET, CUSTOMER_TYPE_UPDATE, CUSTOMER_TYPE_DELETE, CUSTOMER_TYPE_ADD_DISCOUNT, CUSTOMER_TYPE_UPDATE_DISCOUNT, CUSTOMER_TYPE_DELETE_DISCOUNT, CUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORM, CUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORM, DEBT_UPLOAD_IMAGE, DEBT_FETCH, DEBT_GET, DEBT_PAYMENT, DELIVERY_ORDER_CREATE, DELIVERY_ORDER_UPLOAD, DELIVERY_ORDER_ADD_ITEM, DELIVERY_ORDER_ADD_IMAGE, DELIVERY_ORDER_ADD_DRIVER, DELIVERY_ORDER_FETCH, DELIVERY_ORDER_FETCH_DRIVER, DELIVERY_ORDER_GET, DELIVERY_ORDER_ACTIVE_FOR_DRIVER, DELIVERY_ORDER_MARK_ONGOING, DELIVERY_ORDER_DELIVERING, DELIVERY_ORDER_UPDATE, DELIVERY_ORDER_CANCEL, DELIVERY_ORDER_MARK_COMPLETED, DELIVERY_ORDER_DELIVERY_LOCATION, DELIVERY_ORDER_DELETE, DELIVERY_ORDER_DELETE_ITEM, DELIVERY_ORDER_DELETE_IMAGE, DELIVERY_ORDER_DELETE_DRIVER, DELIVERY_ORDER_REVIEW_FETCH, DELIVERY_ORDER_REVIEW_GET, PRODUCT_CREATE, PRODUCT_UPLOAD, PRODUCT_FETCH, PRODUCT_GET, PRODUCT_UPDATE, PRODUCT_DELETE, PRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORM, PRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORM, PRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORM, PRODUCT_OPTION_FOR_CART_ADD_ITEM_FORM, PRODUCT_DISCOUNT_CREATE, PRODUCT_DISCOUNT_FETCH, PRODUCT_DISCOUNT_GET, PRODUCT_DISCOUNT_UPDATE, PRODUCT_DISCOUNT_DELETE, PRODUCT_RECEIVE_CREATE, PRODUCT_RECEIVE_UPLOAD, PRODUCT_RECEIVE_ADD_ITEM, PRODUCT_RECEIVE_ADD_IMAGE, PRODUCT_RECEIVE_UPDATE, PRODUCT_RECEIVE_CANCEL, PRODUCT_RECEIVE_MARK_COMPLETE, PRODUCT_RECEIVE_FETCH, PRODUCT_RECEIVE_GET, PRODUCT_RECEIVE_DELETE, PRODUCT_RECEIVE_DELETE_ITEM, PRODUCT_RECEIVE_DELETE_IMAGE, PRODUCT_STOCK_FETCH, PRODUCT_STOCK_GET, PRODUCT_STOCK_DOWNLOAD_REPORT, PRODUCT_STOCK_ADJUSTMENT, PRODUCT_UNIT_CREATE, PRODUCT_UNIT_GET, PRODUCT_UNIT_UPDATE, PRODUCT_UNIT_DELETE, PRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORM, PRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORM, ROLE_OPTION_FOR_USER_FORM, SHOP_ORDER_FETCH, SHOP_ORDER_GET, SSR_WHATSAPP_LOGIN, SUPPLIER_CREATE, SUPPLIER_FETCH, SUPPLIER_GET, SUPPLIER_UPDATE, SUPPLIER_DELETE, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORM, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTER, SUPPLIER_TYPE_CREATE, SUPPLIER_TYPE_FETCH, SUPPLIER_TYPE_GET, SUPPLIER_TYPE_UPDATE, SUPPLIER_TYPE_DELETE, SUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORM, TIKTOK_PRODUCT_CREATE, TIKTOK_PRODUCT_UPLOAD_IMAGE, TIKTOK_PRODUCT_FETCH_BRANDS, TIKTOK_PRODUCT_FETCH_CATEGORIES, TIKTOK_PRODUCT_GET_RULES, TIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTES, TIKTOK_PRODUCT_GET, TIKTOK_PRODUCT_UPDATE, TIKTOK_PRODUCT_RECOMMENDED_CATEGORY, TIKTOK_PRODUCT_RECOMMENDED_ACTIVATE, TIKTOK_PRODUCT_RECOMMENDED_DEACTIVATE, TRANSACTION_CHECKOUT_CART, TRANSACTION_GET, USER_CREATE, USER_FETCH, USER_GET, USER_UPDATE, USER_UPDATE_PASSWORD, USER_UPDATE_ACTIVE, USER_UPDATE_INACTIVE, USER_ADD_ROLE, USER_DELETE_ROLE, USER_OPTION_FOR_CASHIER_SESSION_FILTER, USER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORM, UNIT_CREATE, UNIT_FETCH, UNIT_GET, UNIT_UPDATE, UNIT_DELETE, UNIT_OPTION_FOR_PRODUCT_UNIT_FORM, UNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORM, WHATSAPP_IS_LOGGED_IN, WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST, WHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCAST, WHATSAPP_LOGOUT"

const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_FETCHPRODUCT_DISCOUNT_GETPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 879, 889, 897, 909, 930, 951, 974, 998, 1023, 1043, 1070, 1088, 1120, 1147, 1172, 1193, 1214, 1243, 1275, 1296, 1322, 1349, 1377, 1404, 1429, 1443, 1457, 1470, 1481, 1495, 1509, 1553, 1596, 1642, 1679, 1702, 1724, 1744, 1767, 1790, 1812, 1834, 1858, 1883, 1905, 1927, 1956, 1977, 1996, 2018, 2045, 2073, 2092, 2109, 2138, 2162, 2181, 2197, 2216, 2235, 2284, 2332, 2357, 2373, 2387, 2405, 2420, 2434, 2446, 2461, 2476, 2516, 2558, 2578, 2597, 2614, 2634, 2654, 2692, 2713, 2740, 2767, 2798, 2822, 2860, 2878, 2899, 2934, 2969, 3006, 3031, 3046, 3057, 3067, 3075, 3086, 3106, 3124, 3144, 3157, 3173, 3211, 3253, 3264, 3274, 3282, 3293, 3304, 3337, 3378, 3399, 3438, 3479, 3494}
