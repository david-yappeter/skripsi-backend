...
func _() {
	...
	_ = x[PermissionCustomerDebtDownloadReport-30]
	_ = x[PermissionCustomerDebtFetch-31]
	_ = x[PermissionCustomerDebtGet-32]
	_ = x[PermissionCustomerDebtPayment-33]
	_ = x[PermissionCustomerTypeCreate-34]
	_ = x[PermissionCustomerTypeFetch-35]
	_ = x[PermissionCustomerTypeGet-36]
	_ = x[PermissionCustomerTypeUpdate-37]
	_ = x[PermissionCustomerTypeDelete-38]
	_ = x[PermissionCustomerTypeAddDiscount-39]
	_ = x[PermissionCustomerTypeUpdateDiscount-40]
	_ = x[PermissionCustomerTypeDeleteDiscount-41]
	_ = x[PermissionCustomerTypeOptionForCustomerForm-42]
	_ = x[PermissionCustomerTypeOptionForWhatsappProductPriceChangeBroadcastForm-43]
	_ = x[PermissionDashboardSummarizeDebt-44]
	_ = x[PermissionDashboardSummarizeTransaction-45]
	_ = x[PermissionDebtUploadImage-46]
	_ = x[PermissionDebtFetch-47]
	_ = x[PermissionDebtDownloadReport-48]
	_ = x[PermissionDebtGet-49]
	_ = x[PermissionDebtPayment-50]
	_ = x[PermissionDeliveryOrderCreate-51]
	_ = x[PermissionDeliveryOrderUpload-52]
	_ = x[PermissionDeliveryOrderAddItem-53]
	_ = x[PermissionDeliveryOrderAddImage-54]
	_ = x[PermissionDeliveryOrderAddDriver-55]
	_ = x[PermissionDeliveryOrderFetch-56]
	_ = x[PermissionDeliveryOrderFetchDriver-57]
	_ = x[PermissionDeliveryOrderGet-58]
	_ = x[PermissionDeliveryOrderActiveForDriver-59]
	_ = x[PermissionDeliveryOrderMarkOngoing-60]
	_ = x[PermissionDeliveryOrderDelivering-61]
	_ = x[PermissionDeliveryOrderUpdate-62]
	_ = x[PermissionDeliveryOrderCancel-63]
	_ = x[PermissionDeliveryOrderMarkCompleted-64]
	_ = x[PermissionDeliveryOrderReturned-65]
	_ = x[PermissionDeliveryOrderDeliveryLocation-66]
	_ = x[PermissionDeliveryOrderDelete-67]
	_ = x[PermissionDeliveryOrderDeleteItem-68]
	_ = x[PermissionDeliveryOrderDeleteImage-69]
	_ = x[PermissionDeliveryOrderDeleteDriver-70]
	_ = x[PermissionDeliveryOrderReviewFetch-71]
	_ = x[PermissionDeliveryOrderReviewGet-72]
	_ = x[PermissionProductCreate-73]
	_ = x[PermissionProductUpload-74]
	_ = x[PermissionProductFetch-75]
	_ = x[PermissionProductGet-76]
	_ = x[PermissionProductUpdate-77]
	_ = x[PermissionProductDelete-78]
	_ = x[PermissionProductOptionForProductReceiveItemForm-79]
	_ = x[PermissionProductOptionForDeliveryOrderItemForm-80]
	_ = x[PermissionProductOptionForCustomerTypeDiscountForm-81]
	_ = x[PermissionProductOptionForCartAddItemForm-82]
	_ = x[PermissionProductOptionForProductDiscountForm-83]
	_ = x[PermissionProductDiscountCreate-84]
	_ = x[PermissionProductDiscountFetch-85]
	_ = x[PermissionProductDiscountGet-86]
	_ = x[PermissionProductDiscountUpdate-87]
	_ = x[PermissionProductDiscountDelete-88]
	_ = x[PermissionProductReceiveUpload-89]
	_ = x[PermissionProductReceiveAddImage-90]
	_ = x[PermissionProductReceiveUpdate-91]
	_ = x[PermissionProductReceiveCancel-92]
	_ = x[PermissionProductReceiveMarkComplete-93]
	_ = x[PermissionProductReceiveFetch-94]
	_ = x[PermissionProductReceiveGet-95]
	_ = x[PermissionProductReceiveUpdateItem-96]
	_ = x[PermissionProductReceiveDelete-97]
	_ = x[PermissionProductReceiveDeleteImage-98]
	_ = x[PermissionProductReturnCreate-99]
	_ = x[PermissionProductReturnUpload-100]
	_ = x[PermissionProductReturnAddItem-101]
	_ = x[PermissionProductReturnAddImage-102]
	_ = x[PermissionProductReturnUpdate-103]
	_ = x[PermissionProductReturnCancel-104]
	_ = x[PermissionProductReturnMarkComplete-105]
	_ = x[PermissionProductReturnFetch-106]
	_ = x[PermissionProductReturnGet-107]
	_ = x[PermissionProductReturnDelete-108]
	_ = x[PermissionProductReturnDeleteItem-109]
	_ = x[PermissionProductReturnDeleteImage-110]
	_ = x[PermissionProductStockAdjustmentFetch-111]
	_ = x[PermissionProductStockFetch-112]
	_ = x[PermissionProductStockGet-113]
	_ = x[PermissionProductStockDownloadReport-114]
	_ = x[PermissionProductStockAdjustment-115]
	_ = x[PermissionProductUnitCreate-116]
	_ = x[PermissionProductUnitGet-117]
	_ = x[PermissionProductUnitUpdate-118]
	_ = x[PermissionProductUnitDelete-119]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-120]
	_ = x[PermissionProductUnitOptionForDeliveryOrderItemForm-121]
	_ = x[PermissionPurchaseOrderCreate-122]
	_ = x[PermissionPurchaseOrderUpload-123]
	_ = x[PermissionPurchaseOrderAddItem-124]
	_ = x[PermissionPurchaseOrderAddImage-125]
	_ = x[PermissionPurchaseOrderUpdate-126]
	_ = x[PermissionPurchaseOrderCancel-127]
	_ = x[PermissionPurchaseOrderOngoing-128]
	_ = x[PermissionPurchaseOrderMarkComplete-129]
	_ = x[PermissionPurchaseOrderFetch-130]
	_ = x[PermissionPurchaseOrderGet-131]
	_ = x[PermissionPurchaseOrderDelete-132]
	_ = x[PermissionPurchaseOrderDeleteItem-133]
	_ = x[PermissionPurchaseOrderDeleteImage-134]
	_ = x[PermissionRoleOptionForUserForm-135]
	_ = x[PermissionShopOrderFetch-136]
	_ = x[PermissionShopOrderGet-137]
	_ = x[PermissionSsrWhatsappLogin-138]
	_ = x[PermissionSupplierCreate-139]
	_ = x[PermissionSupplierFetch-140]
	_ = x[PermissionSupplierGet-141]
	_ = x[PermissionSupplierUpdate-142]
	_ = x[PermissionSupplierDelete-143]
	_ = x[PermissionSupplierOptionForProductReceiveForm-144]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-145]
	_ = x[PermissionSupplierTypeCreate-146]
	_ = x[PermissionSupplierTypeFetch-147]
	_ = x[PermissionSupplierTypeGet-148]
	_ = x[PermissionSupplierTypeUpdate-149]
	_ = x[PermissionSupplierTypeDelete-150]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-151]
	_ = x[PermissionTiktokProductCreate-152]
	_ = x[PermissionTiktokProductUploadImage-153]
	_ = x[PermissionTiktokProductFetchBrands-154]
	_ = x[PermissionTiktokProductFetchCategories-155]
	_ = x[PermissionTiktokProductGetCategoryRules-156]
	_ = x[PermissionTiktokProductGetCategoryAttributes-157]
	_ = x[PermissionTiktokProductGet-158]
	_ = x[PermissionTiktokProductUpdate-159]
	_ = x[PermissionTiktokProductRecommendedCategory-160]
	_ = x[PermissionTiktokProductActivate-161]
	_ = x[PermissionTiktokProductDeactivate-162]
	_ = x[PermissionTransactionCheckoutCart-163]
	_ = x[PermissionTransactionGet-164]
	_ = x[PermissionUserCreate-165]
	_ = x[PermissionUserFetch-166]
	_ = x[PermissionUserGet-167]
	_ = x[PermissionUserUpdate-168]
	_ = x[PermissionUserUpdatePassword-169]
	_ = x[PermissionUserUpdateActive-170]
	_ = x[PermissionUserUpdateInActive-171]
	_ = x[PermissionUserAddRole-172]
	_ = x[PermissionUserDeleteRole-173]
	_ = x[PermissionUserOptionForCashierSessionFilter-174]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-175]
	_ = x[PermissionUserOptionForProductStockAdjustmentFilter-176]
	_ = x[PermissionUnitCreate-177]
	_ = x[PermissionUnitFetch-178]
	_ = x[PermissionUnitGet-179]
	_ = x[PermissionUnitUpdate-180]
	_ = x[PermissionUnitDelete-181]
	_ = x[PermissionUnitOptionForProductUnitForm-182]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-183]
	_ = x[PermissionWhatsappIsLoggedIn-184]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-185]
	_ = x[PermissionWhatsappCustomerDebtBroadcast-186]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-187]
	_ = x[PermissionWhatsappLogout-188]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_FETCH_FOR_CURRENT_USERCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_WHATSAPP_CUSTOMER_DEBT_BROADCAST_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_DOWNLOAD_REPORTCUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDASHBOARD_SUMMARIZE_DEBTDASHBOARD_SUMMARIZE_TRANSACTIONDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_DOWNLOAD_REPORTDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_RETURNEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_OPTION_FOR_PRODUCT_DISCOUNT_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_FETCHPRODUCT_DISCOUNT_GETPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_UPDATE_ITEMPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_RETURN_CREATEPRODUCT_RETURN_UPLOADPRODUCT_RETURN_ADD_ITEMPRODUCT_RETURN_ADD_IMAGEPRODUCT_RETURN_UPDATEPRODUCT_RETURN_CANCELPRODUCT_RETURN_MARK_COMPLETEPRODUCT_RETURN_FETCHPRODUCT_RETURN_GETPRODUCT_RETURN_DELETEPRODUCT_RETURN_DELETE_ITEMPRODUCT_RETURN_DELETE_IMAGEPRODUCT_STOCK_ADJUSTMENT_FETCHPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPURCHASE_ORDER_CREATEPURCHASE_ORDER_UPLOADPURCHASE_ORDER_ADD_ITEMPURCHASE_ORDER_ADD_IMAGEPURCHASE_ORDER_UPDATEPURCHASE_ORDER_CANCELPURCHASE_ORDER_ONGOINGPURCHASE_ORDER_MARK_COMPLETEPURCHASE_ORDER_FETCHPURCHASE_ORDER_GETPURCHASE_ORDER_DELETEPURCHASE_ORDER_DELETE_ITEMPURCHASE_ORDER_DELETE_IMAGEROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUSER_OPTION_FOR_PRODUCT_STOCK_ADJUSTMENT_FILTERUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_DEBT_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 229, 250, 269, 302, 333, 360, 379, 394, 408, 420, 435, 450, 507, 546, 587, 613, 642, 661, 678, 699, 719, 738, 755, 775, 795, 821, 850, 879, 917, 986, 1010, 1041, 1058, 1068, 1088, 1096, 1108, 1129, 1150, 1173, 1197, 1222, 1242, 1269, 1287, 1319, 1346, 1371, 1392, 1413, 1442, 1465, 1497, 1518, 1544, 1571, 1599, 1626, 1651, 1665, 1679, 1692, 1703, 1717, 1731, 1775, 1818, 1864, 1901, 1941, 1964, 1986, 2006, 2029, 2052, 2074, 2099, 2121, 2143, 2172, 2193, 2212, 2239, 2261, 2289, 2310, 2331, 2354, 2378, 2399, 2420, 2448, 2468, 2486, 2507, 2533, 2560, 2590, 2609, 2626, 2655, 2679, 2698, 2714, 2733, 2752, 2801, 2849, 2870, 2891, 2914, 2938, 2959, 2980, 3002, 3030, 3050, 3068, 3089, 3115, 3142, 3167, 3183, 3197, 3215, 3230, 3244, 3256, 3271, 3286, 3326, 3368, 3388, 3407, 3424, 3444, 3464, 3502, 3523, 3550, 3577, 3608, 3632, 3670, 3688, 3709, 3744, 3779, 3816, 3841, 3856, 3867, 3877, 3885, 3896, 3916, 3934, 3954, 3967, 3983, 4021, 4063, 4110, 4121, 4131, 4139, 4150, 4161, 4194, 4235, 4256, 4295, 4327, 4368, 4383}
