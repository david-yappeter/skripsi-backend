...
func _() {
	...
	_ = x[PermissionProductReceiveDelete-92]
	_ = x[PermissionProductReceiveDeleteItem-93]
	_ = x[PermissionProductReceiveDeleteImage-94]
	_ = x[PermissionProductStockFetch-95]
	_ = x[PermissionProductStockGet-96]
	_ = x[PermissionProductStockDownloadReport-97]
	_ = x[PermissionProductStockAdjustment-98]
	_ = x[PermissionProductUnitCreate-99]
	_ = x[PermissionProductUnitGet-100]
	_ = x[PermissionProductUnitUpdate-101]
	_ = x[PermissionProductUnitDelete-102]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-103]
	_ = x[PermissionProductUnitOptionForDeliveryOrderItemForm-104]
	_ = x[PermissionRoleOptionForUserForm-105]
	_ = x[PermissionShopOrderFetch-106]
	_ = x[PermissionShopOrderGet-107]
	_ = x[PermissionSsrWhatsappLogin-108]
	_ = x[PermissionSupplierCreate-109]
	_ = x[PermissionSupplierFetch-110]
	_ = x[PermissionSupplierGet-111]
	_ = x[PermissionSupplierUpdate-112]
	_ = x[PermissionSupplierDelete-113]
	_ = x[PermissionSupplierOptionForProductReceiveForm-114]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-115]
	_ = x[PermissionSupplierTypeCreate-116]
	_ = x[PermissionSupplierTypeFetch-117]
	_ = x[PermissionSupplierTypeGet-118]
	_ = x[PermissionSupplierTypeUpdate-119]
	_ = x[PermissionSupplierTypeDelete-120]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-121]
	_ = x[PermissionTiktokProductCreate-122]
	_ = x[PermissionTiktokProductUploadImage-123]
	_ = x[PermissionTiktokProductFetchBrands-124]
	_ = x[PermissionTiktokProductFetchCategories-125]
	_ = x[PermissionTiktokProductGetCategoryRules-126]
	_ = x[PermissionTiktokProductGetCategoryAttributes-127]
	_ = x[PermissionTiktokProductGet-128]
	_ = x[PermissionTiktokProductUpdate-129]
	_ = x[PermissionTiktokProductRecommendedCategory-130]
	_ = x[PermissionTiktokProductActivate-131]
	_ = x[PermissionTiktokProductDeactivate-132]
	_ = x[PermissionTransactionCheckoutCart-133]
	_ = x[PermissionTransactionGet-134]
	_ = x[PermissionUserCreate-135]
	_ = x[PermissionUserFetch-136]
	_ = x[PermissionUserGet-137]
	_ = x[PermissionUserUpdate-138]
	_ = x[PermissionUserUpdatePassword-139]
	_ = x[PermissionUserUpdateActive-140]
	_ = x[PermissionUserUpdateInActive-141]
	_ = x[PermissionUserAddRole-142]
	_ = x[PermissionUserDeleteRole-143]
	_ = x[PermissionUserOptionForCashierSessionFilter-144]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-145]
	_ = x[PermissionUnitCreate-146]
	_ = x[PermissionUnitFetch-147]
	_ = x[PermissionUnitGet-148]
	_ = x[PermissionUnitUpdate-149]
	_ = x[PermissionUnitDelete-150]
	_ = x[PermissionUnitOptionForProductUnitForm-151]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-152]
	_ = x[PermissionWhatsappIsLoggedIn-153]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-154]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-155]
	_ = x[PermissionWhatsappLogout-156]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_RETURNEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_OPTION_FOR_PRODUCT_DISCOUNT_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_FETCHPRODUCT_DISCOUNT_GETPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 879, 889, 897, 909, 930, 951, 974, 998, 1023, 1043, 1070, 1088, 1120, 1147, 1172, 1193, 1214, 1243, 1266, 1298, 1319, 1345, 1372, 1400, 1427, 1452, 1466, 1480, 1493, 1504, 1518, 1532, 1576, 1619, 1665, 1702, 1742, 1765, 1787, 1807, 1830, 1853, 1875, 1897, 1921, 1946, 1968, 1990, 2019, 2040, 2059, 2081, 2108, 2136, 2155, 2172, 2201, 2225, 2244, 2260, 2279, 2298, 2347, 2395, 2420, 2436, 2450, 2468, 2483, 2497, 2509, 2524, 2539, 2579, 2621, 2641, 2660, 2677, 2697, 2717, 2755, 2776, 2803, 2830, 2861, 2885, 2923, 2941, 2962, 2997, 3032, 3069, 3094, 3109, 3120, 3130, 3138, 3149, 3169, 3187, 3207, 3220, 3236, 3274, 3316, 3327, 3337, 3345, 3356, 3367, 3400, 3441, 3462, 3501, 3542, 3557}
