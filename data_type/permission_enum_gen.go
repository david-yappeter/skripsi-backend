...
func _() {
	...
	_ = x[PermissionProductStockDownloadReport-74]
	_ = x[PermissionProductStockAdjustment-75]
	_ = x[PermissionProductUnitCreate-76]
	_ = x[PermissionProductUnitGet-77]
	_ = x[PermissionProductUnitUpdate-78]
	_ = x[PermissionProductUnitDelete-79]
	_ = x[PermissionProductUnitOptionForProductReceiveForm-80]
	_ = x[PermissionProductUnitOptionForDeliveryOrderForm-81]
	_ = x[PermissionRoleOptionForUserForm-82]
	_ = x[PermissionShopOrderFetch-83]
	_ = x[PermissionShopOrderGet-84]
	_ = x[PermissionSupplierCreate-85]
	_ = x[PermissionSupplierFetch-86]
	_ = x[PermissionSupplierGet-87]
	_ = x[PermissionSupplierUpdate-88]
	_ = x[PermissionSupplierDelete-89]
	_ = x[PermissionSupplierOptionForProductReceiveForm-90]
	_ = x[PermissionSupplierTypeCreate-91]
	_ = x[PermissionSupplierTypeFetch-92]
	_ = x[PermissionSupplierTypeGet-93]
	_ = x[PermissionSupplierTypeUpdate-94]
	_ = x[PermissionSupplierTypeDelete-95]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-96]
	_ = x[PermissionTiktokProductCreate-97]
	_ = x[PermissionTiktokProductUploadImage-98]
	_ = x[PermissionTiktokProductFetchBrands-99]
	_ = x[PermissionTiktokProductFetchCategories-100]
	_ = x[PermissionTiktokProductGetCategoryRules-101]
	_ = x[PermissionTiktokProductGetCategoryAttributes-102]
	_ = x[PermissionTiktokProductGet-103]
	_ = x[PermissionTiktokProductUpdate-104]
	_ = x[PermissionTiktokProductRecommendedCategory-105]
	_ = x[PermissionTiktokProductActivate-106]
	_ = x[PermissionTiktokProductDeactivate-107]
	_ = x[PermissionTransactionCheckoutCart-108]
	_ = x[PermissionUserCreate-109]
	_ = x[PermissionUserFetch-110]
	_ = x[PermissionUserGet-111]
	_ = x[PermissionUserUpdate-112]
	_ = x[PermissionUserUpdatePassword-113]
	_ = x[PermissionUserUpdateActive-114]
	_ = x[PermissionUserUpdateInActive-115]
	_ = x[PermissionUserAddRole-116]
	_ = x[PermissionUserDeleteRole-117]
	_ = x[PermissionUnitCreate-118]
	_ = x[PermissionUnitFetch-119]
	_ = x[PermissionUnitGet-120]
	_ = x[PermissionUnitUpdate-121]
	_ = x[PermissionUnitDelete-122]
	_ = x[PermissionUnitOptionForProductUnitForm-123]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_STARTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_ADD_DISCOUNTCUSTOMER_TYPE_OPTION_UPDATE_DISCOUNTCUSTOMER_TYPE_OPTION_DELETE_DISCOUNTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORM"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 218, 237, 252, 266, 278, 293, 308, 347, 373, 392, 409, 430, 450, 469, 486, 506, 526, 564, 597, 633, 669, 690, 711, 734, 758, 783, 803, 821, 848, 869, 898, 919, 945, 972, 1000, 1014, 1028, 1041, 1052, 1066, 1080, 1119, 1157, 1194, 1217, 1240, 1263, 1285, 1307, 1331, 1356, 1378, 1407, 1428, 1447, 1469, 1496, 1524, 1543, 1560, 1589, 1613, 1632, 1648, 1667, 1686, 1730, 1773, 1798, 1814, 1828, 1843, 1857, 1869, 1884, 1899, 1939, 1959, 1978, 1995, 2015, 2035, 2073, 2094, 2121, 2148, 2179, 2203, 2241, 2259, 2280, 2315, 2350, 2387, 2412, 2423, 2433, 2441, 2452, 2472, 2490, 2510, 2523, 2539, 2550, 2560, 2568, 2579, 2590, 2623}
