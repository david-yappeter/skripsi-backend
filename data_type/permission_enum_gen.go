...
func _() {
	...
	_ = x[PermissionCashierSessionGetCurrent-15]
	_ = x[PermissionCashierSessionEnd-16]
	_ = x[PermissionCustomerCreate-17]
	_ = x[PermissionCustomerFetch-18]
	_ = x[PermissionCustomerGet-19]
	_ = x[PermissionCustomerUpdate-20]
	_ = x[PermissionCustomerDelete-21]
	_ = x[PermissionCustomerOptionForDeliveryOrderForm-22]
	_ = x[PermissionCustomerDebtUploadImage-23]
	_ = x[PermissionCustomerDebtFetch-24]
	_ = x[PermissionCustomerDebtGet-25]
	_ = x[PermissionCustomerDebtPayment-26]
	_ = x[PermissionCustomerTypeCreate-27]
	_ = x[PermissionCustomerTypeFetch-28]
	_ = x[PermissionCustomerTypeGet-29]
	_ = x[PermissionCustomerTypeUpdate-30]
	_ = x[PermissionCustomerTypeDelete-31]
	_ = x[PermissionCustomerTypeOptionForCustomerForm-32]
	_ = x[PermissionCustomerTypeAddDiscount-33]
	_ = x[PermissionCustomerTypeUpdateDiscount-34]
	_ = x[PermissionCustomerTypeDeleteDiscount-35]
	_ = x[PermissionDeliveryOrderCreate-36]
	_ = x[PermissionDeliveryOrderUpload-37]
	_ = x[PermissionDeliveryOrderAddItem-38]
	_ = x[PermissionDeliveryOrderAddImage-39]
	_ = x[PermissionDeliveryOrderAddDriver-40]
	_ = x[PermissionDeliveryOrderFetch-41]
	_ = x[PermissionDeliveryOrderGet-42]
	_ = x[PermissionDeliveryOrderMarkOngoing-43]
	_ = x[PermissionDeliveryOrderCancel-44]
	_ = x[PermissionDeliveryOrderMarkCompleted-45]
	_ = x[PermissionDeliveryOrderDelete-46]
	_ = x[PermissionDeliveryOrderDeleteItem-47]
	_ = x[PermissionDeliveryOrderDeleteImage-48]
	_ = x[PermissionDeliveryOrderDeleteDriver-49]
	_ = x[PermissionProductCreate-50]
	_ = x[PermissionProductUpload-51]
	_ = x[PermissionProductFetch-52]
	_ = x[PermissionProductGet-53]
	_ = x[PermissionProductUpdate-54]
	_ = x[PermissionProductDelete-55]
	_ = x[PermissionProductOptionForProductReceiveForm-56]
	_ = x[PermissionProductOptionForDeliveryOrderForm-57]
	_ = x[PermissionProductOptionForCustomerTypeForm-58]
	_ = x[PermissionProductDiscountCreate-59]
	_ = x[PermissionProductDiscountUpdate-60]
	_ = x[PermissionProductDiscountDelete-61]
	_ = x[PermissionProductReceiveCreate-62]
	_ = x[PermissionProductReceiveUpload-63]
	_ = x[PermissionProductReceiveAddItem-64]
	_ = x[PermissionProductReceiveAddImage-65]
	_ = x[PermissionProductReceiveCancel-66]
	_ = x[PermissionProductReceiveMarkComplete-67]
	_ = x[PermissionProductReceiveFetch-68]
	_ = x[PermissionProductReceiveGet-69]
	_ = x[PermissionProductReceiveDelete-70]
	_ = x[PermissionProductReceiveDeleteItem-71]
	_ = x[PermissionProductReceiveDeleteImage-72]
	_ = x[PermissionProductStockFetch-73]
	_ = x[PermissionProductStockGet-74]
	_ = x[PermissionProductStockDownloadReport-75]
	_ = x[PermissionProductStockAdjustment-76]
	_ = x[PermissionProductUnitCreate-77]
	_ = x[PermissionProductUnitGet-78]
	_ = x[PermissionProductUnitUpdate-79]
	_ = x[PermissionProductUnitDelete-80]
	_ = x[PermissionProductUnitOptionForProductReceiveForm-81]
	_ = x[PermissionProductUnitOptionForDeliveryOrderForm-82]
	_ = x[PermissionRoleOptionForUserForm-83]
	_ = x[PermissionShopOrderFetch-84]
	_ = x[PermissionShopOrderGet-85]
	_ = x[PermissionSupplierCreate-86]
	_ = x[PermissionSupplierFetch-87]
	_ = x[PermissionSupplierGet-88]
	_ = x[PermissionSupplierUpdate-89]
	_ = x[PermissionSupplierDelete-90]
	_ = x[PermissionSupplierOptionForProductReceiveForm-91]
	_ = x[PermissionSupplierTypeCreate-92]
	_ = x[PermissionSupplierTypeFetch-93]
	_ = x[PermissionSupplierTypeGet-94]
	_ = x[PermissionSupplierTypeUpdate-95]
	_ = x[PermissionSupplierTypeDelete-96]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-97]
	_ = x[PermissionTiktokProductCreate-98]
	_ = x[PermissionTiktokProductUploadImage-99]
	_ = x[PermissionTiktokProductFetchBrands-100]
	_ = x[PermissionTiktokProductFetchCategories-101]
	_ = x[PermissionTiktokProductGetCategoryRules-102]
	_ = x[PermissionTiktokProductGetCategoryAttributes-103]
	_ = x[PermissionTiktokProductGet-104]
	_ = x[PermissionTiktokProductUpdate-105]
	_ = x[PermissionTiktokProductRecommendedCategory-106]
	_ = x[PermissionTiktokProductActivate-107]
	_ = x[PermissionTiktokProductDeactivate-108]
	_ = x[PermissionTransactionCheckoutCart-109]
	_ = x[PermissionUserCreate-110]
	_ = x[PermissionUserFetch-111]
	_ = x[PermissionUserGet-112]
	_ = x[PermissionUserUpdate-113]
	_ = x[PermissionUserUpdatePassword-114]
	_ = x[PermissionUserUpdateActive-115]
	_ = x[PermissionUserUpdateInActive-116]
	_ = x[PermissionUserAddRole-117]
	_ = x[PermissionUserDeleteRole-118]
	_ = x[PermissionUnitCreate-119]
	_ = x[PermissionUnitFetch-120]
	_ = x[PermissionUnitGet-121]
	_ = x[PermissionUnitUpdate-122]
	_ = x[PermissionUnitDelete-123]
	_ = x[PermissionUnitOptionForProductUnitForm-124]
}

const _Permission_nameReadable = "BALANCE_CREATE, BALANCE_FETCH, BALANCE_GET, BALANCE_UPDATE, BALANCE_DELETE, CART_GET_ACTIVE, CART_ADD_ITEM, CART_UPDATE_ITEM, CART_DELETE_ITEM, CART_SET_ACTIVE, CART_SET_IN_ACTIVE, CART_DELETE, CASHIER_SESSION_FETCH, CASHIER_SESSION_START, CASHIER_SESSION_GET_CURRENT, CASHIER_SESSION_END, CUSTOMER_CREATE, CUSTOMER_FETCH, CUSTOMER_GET, CUSTOMER_UPDATE, CUSTOMER_DELETE, CUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORM, CUSTOMER_DEBT_UPLOAD_IMAGE, CUSTOMER_DEBT_FETCH, CUSTOMER_DEBT_GET, CUSTOMER_DEBT_PAYMENT, CUSTOMER_TYPE_CREATE, CUSTOMER_TYPE_FETCH, CUSTOMER_TYPE_GET, CUSTOMER_TYPE_UPDATE, CUSTOMER_TYPE_DELETE, CUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORM, CUSTOMER_TYPE_OPTION_ADD_DISCOUNT, CUSTOMER_TYPE_OPTION_UPDATE_DISCOUNT, CUSTOMER_TYPE_OPTION_DELETE_DISCOUNT, DELIVERY_ORDER_CREATE, DELIVERY_ORDER_UPLOAD, DELIVERY_ORDER_ADD_ITEM, DELIVERY_ORDER_ADD_IMAGE, DELIVERY_ORDER_ADD_DRIVER, DELIVERY_ORDER_FETCH, DELIVERY_ORDER_GET, DELIVERY_ORDER_MARK_ONGOING, DELIVERY_ORDER_CANCEL, DELIVERY_ORDER_MARK_COMPLETED, DELIVERY_ORDER_DELETE, DELIVERY_ORDER_DELETE_ITEM, DELIVERY_ORDER_DELETE_IMAGE, DELIVERY_ORDER_DELETE_DRIVER, PRODUCT_CREATE, PRODUCT_UPLOAD, PRODUCT_FETCH, PRODUCT_GET, PRODUCT_UPDATE, PRODUCT_DELETE, PRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORM, PRODUCT_OPTION_FOR_DELIVERY_ORDER_FORM, PRODUCT_OPTION_FOR_CUSTOMER_TYPE_FORM, PRODUCT_DISCOUNT_CREATE, PRODUCT_DISCOUNT_UPDATE, PRODUCT_DISCOUNT_DELETE, PRODUCT_RECEIVE_CREATE, PRODUCT_RECEIVE_UPLOAD, PRODUCT_RECEIVE_ADD_ITEM, PRODUCT_RECEIVE_ADD_IMAGE, PRODUCT_RECEIVE_CANCEL, PRODUCT_RECEIVE_MARK_COMPLETE, PRODUCT_RECEIVE_FETCH, PRODUCT_RECEIVE_GET, PRODUCT_RECEIVE_DELETE, PRODUCT_RECEIVE_DELETE_ITEM, PRODUCT_RECEIVE_DELETE_IMAGE, PRODUCT_STOCK_FETCH, PRODUCT_STOCK_GET, PRODUCT_STOCK_DOWNLOAD_REPORT, PRODUCT_STOCK_ADJUSTMENT, PRODUCT_UNIT_CREATE, PRODUCT_UNIT_GET, PRODUCT_UNIT_UPDATE, PRODUCT_UNIT_DELETE, PRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORM, PRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORM, ROLE_OPTION_FOR_USER_FORM, SHOP_ORDER_FETCH, SHOP_ORDER_GET, SUPPLIER_CREATE, SUPPLIER_FETCH, SUPPLIER_GET, SUPPLIER_UPDATE, SUPPLIER_DELETE, SUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORM, SUPPLIER_TYPE_CREATE, SUPPLIER_TYPE_FETCH, SUPPLIER_TYPE_GET, SUPPLIER_TYPE_UPDATE, SUPPLIER_TYPE_DELETE, SUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORM, TIKTOK_PRODUCT_CREATE, TIKTOK_PRODUCT_UPLOAD_IMAGE, TIKTOK_PRODUCT_FETCH_BRANDS, TIKTOK_PRODUCT_FETCH_CATEGORIES, TIKTOK_PRODUCT_GET_RULES, TIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTES, TIKTOK_PRODUCT_GET, TIKTOK_PRODUCT_UPDATE, TIKTOK_PRODUCT_RECOMMENDED_CATEGORY, TIKTOK_PRODUCT_RECOMMENDED_ACTIVATE, TIKTOK_PRODUCT_RECOMMENDED_DEACTIVATE, TRANSACTION_CHECKOUT_CART, USER_CREATE, USER_FETCH, USER_GET, USER_UPDATE, USER_UPDATE_PASSWORD, USER_UPDATE_ACTIVE, USER_UPDATE_INACTIVE, USER_ADD_ROLE, USER_DELETE_ROLE, UNIT_CREATE, UNIT_FETCH, UNIT_GET, UNIT_UPDATE, UNIT_DELETE, UNIT_OPTION_FOR_PRODUCT_UNIT_FORM"

const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_ADD_DISCOUNTCUSTOMER_TYPE_OPTION_UPDATE_DISCOUNTCUSTOMER_TYPE_OPTION_DELETE_DISCOUNTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_GETDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORM"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 239, 258, 273, 287, 299, 314, 329, 368, 394, 413, 430, 451, 471, 490, 507, 527, 547, 585, 618, 654, 690, 711, 732, 755, 779, 804, 824, 842, 869, 890, 919, 940, 966, 993, 1021, 1035, 1049, 1062, 1073, 1087, 1101, 1140, 1178, 1215, 1238, 1261, 1284, 1306, 1328, 1352, 1377, 1399, 1428, 1449, 1468, 1490, 1517, 1545, 1564, 1581, 1610, 1634, 1653, 1669, 1688, 1707, 1751, 1794, 1819, 1835, 1849, 1864, 1878, 1890, 1905, 1920, 1960, 1980, 1999, 2016, 2036, 2056, 2094, 2115, 2142, 2169, 2200, 2224, 2262, 2280, 2301, 2336, 2371, 2408, 2433, 2444, 2454, 2462, 2473, 2493, 2511, 2531, 2544, 2560, 2571, 2581, 2589, 2600, 2611, 2644}
