...
func _() {
	...
	_ = x[PermissionProductDiscountUpdate-77]
	_ = x[PermissionProductDiscountDelete-78]
	_ = x[PermissionProductReceiveCreate-79]
	_ = x[PermissionProductReceiveUpload-80]
	_ = x[PermissionProductReceiveAddItem-81]
	_ = x[PermissionProductReceiveAddImage-82]
	_ = x[PermissionProductReceiveUpdate-83]
	_ = x[PermissionProductReceiveCancel-84]
	_ = x[PermissionProductReceiveMarkComplete-85]
	_ = x[PermissionProductReceiveFetch-86]
	_ = x[PermissionProductReceiveGet-87]
	_ = x[PermissionProductReceiveDelete-88]
	_ = x[PermissionProductReceiveDeleteItem-89]
	_ = x[PermissionProductReceiveDeleteImage-90]
	_ = x[PermissionProductStockFetch-91]
	_ = x[PermissionProductStockGet-92]
	_ = x[PermissionProductStockDownloadReport-93]
	_ = x[PermissionProductStockAdjustment-94]
	_ = x[PermissionProductUnitCreate-95]
	_ = x[PermissionProductUnitGet-96]
	_ = x[PermissionProductUnitUpdate-97]
	_ = x[PermissionProductUnitDelete-98]
	_ = x[PermissionProductUnitOptionForProductReceiveItemForm-99]
	_ = x[PermissionProductUnitOptionForDeliveryOrderItemForm-100]
	_ = x[PermissionRoleOptionForUserForm-101]
	_ = x[PermissionShopOrderFetch-102]
	_ = x[PermissionShopOrderGet-103]
	_ = x[PermissionSsrWhatsappLogin-104]
	_ = x[PermissionSupplierCreate-105]
	_ = x[PermissionSupplierFetch-106]
	_ = x[PermissionSupplierGet-107]
	_ = x[PermissionSupplierUpdate-108]
	_ = x[PermissionSupplierDelete-109]
	_ = x[PermissionSupplierOptionForProductReceiveForm-110]
	_ = x[PermissionSupplierOptionForProductReceiveFilter-111]
	_ = x[PermissionSupplierTypeCreate-112]
	_ = x[PermissionSupplierTypeFetch-113]
	_ = x[PermissionSupplierTypeGet-114]
	_ = x[PermissionSupplierTypeUpdate-115]
	_ = x[PermissionSupplierTypeDelete-116]
	_ = x[PermissionSupplierTypeOptionForSupplierForm-117]
	_ = x[PermissionTiktokProductCreate-118]
	_ = x[PermissionTiktokProductUploadImage-119]
	_ = x[PermissionTiktokProductFetchBrands-120]
	_ = x[PermissionTiktokProductFetchCategories-121]
	_ = x[PermissionTiktokProductGetCategoryRules-122]
	_ = x[PermissionTiktokProductGetCategoryAttributes-123]
	_ = x[PermissionTiktokProductGet-124]
	_ = x[PermissionTiktokProductUpdate-125]
	_ = x[PermissionTiktokProductRecommendedCategory-126]
	_ = x[PermissionTiktokProductActivate-127]
	_ = x[PermissionTiktokProductDeactivate-128]
	_ = x[PermissionTransactionCheckoutCart-129]
	_ = x[PermissionTransactionGet-130]
	_ = x[PermissionUserCreate-131]
	_ = x[PermissionUserFetch-132]
	_ = x[PermissionUserGet-133]
	_ = x[PermissionUserUpdate-134]
	_ = x[PermissionUserUpdatePassword-135]
	_ = x[PermissionUserUpdateActive-136]
	_ = x[PermissionUserUpdateInActive-137]
	_ = x[PermissionUserAddRole-138]
	_ = x[PermissionUserDeleteRole-139]
	_ = x[PermissionUserOptionForCashierSessionFilter-140]
	_ = x[PermissionUserOptionForDeliveryOrderDriverForm-141]
	_ = x[PermissionUnitCreate-142]
	_ = x[PermissionUnitFetch-143]
	_ = x[PermissionUnitGet-144]
	_ = x[PermissionUnitUpdate-145]
	_ = x[PermissionUnitDelete-146]
	_ = x[PermissionUnitOptionForProductUnitForm-147]
	_ = x[PermissionUnitOptionForProductUnitToUnitForm-148]
	_ = x[PermissionWhatsappIsLoggedIn-149]
	_ = x[PermissionWhatsappProductPriceChangeBroadcast-150]
	_ = x[PermissionWhatsappCustomerTypeDiscountBroadcast-151]
	_ = x[PermissionWhatsappLogout-152]
}
...
const _Permission_name = "BALANCE_CREATEBALANCE_FETCHBALANCE_GETBALANCE_UPDATEBALANCE_DELETECART_GET_ACTIVECART_ADD_ITEMCART_UPDATE_ITEMCART_DELETE_ITEMCART_SET_ACTIVECART_SET_IN_ACTIVECART_DELETECASHIER_SESSION_FETCHCASHIER_SESSION_STARTCASHIER_SESSION_GETCASHIER_SESSION_FETCH_TRANSACTIONCASHIER_SESSION_DOWNLOAD_REPORTCASHIER_SESSION_GET_CURRENTCASHIER_SESSION_ENDCUSTOMER_CREATECUSTOMER_FETCHCUSTOMER_GETCUSTOMER_UPDATECUSTOMER_DELETECUSTOMER_OPTION_FOR_DELIVERY_ORDER_FORMCUSTOMER_OPTION_FOR_DELIVERY_ORDER_FILTERCUSTOMER_DEBT_UPLOAD_IMAGECUSTOMER_DEBT_FETCHCUSTOMER_DEBT_GETCUSTOMER_DEBT_PAYMENTCUSTOMER_TYPE_CREATECUSTOMER_TYPE_FETCHCUSTOMER_TYPE_GETCUSTOMER_TYPE_UPDATECUSTOMER_TYPE_DELETECUSTOMER_TYPE_ADD_DISCOUNTCUSTOMER_TYPE_UPDATE_DISCOUNTCUSTOMER_TYPE_DELETE_DISCOUNTCUSTOMER_TYPE_OPTION_FOR_CUSTOMER_FORMCUSTOMER_TYPE_OPTION_FOR_WHATSAPP_PRODUCT_PRICE_CHANGE_BROADCAST_FORMDEBT_UPLOAD_IMAGEDEBT_FETCHDEBT_GETDEBT_PAYMENTDELIVERY_ORDER_CREATEDELIVERY_ORDER_UPLOADDELIVERY_ORDER_ADD_ITEMDELIVERY_ORDER_ADD_IMAGEDELIVERY_ORDER_ADD_DRIVERDELIVERY_ORDER_FETCHDELIVERY_ORDER_FETCH_DRIVERDELIVERY_ORDER_GETDELIVERY_ORDER_ACTIVE_FOR_DRIVERDELIVERY_ORDER_MARK_ONGOINGDELIVERY_ORDER_DELIVERINGDELIVERY_ORDER_UPDATEDELIVERY_ORDER_CANCELDELIVERY_ORDER_MARK_COMPLETEDDELIVERY_ORDER_DELIVERY_LOCATIONDELIVERY_ORDER_DELETEDELIVERY_ORDER_DELETE_ITEMDELIVERY_ORDER_DELETE_IMAGEDELIVERY_ORDER_DELETE_DRIVERDELIVERY_ORDER_REVIEW_FETCHDELIVERY_ORDER_REVIEW_GETPRODUCT_CREATEPRODUCT_UPLOADPRODUCT_FETCHPRODUCT_GETPRODUCT_UPDATEPRODUCT_DELETEPRODUCT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMPRODUCT_OPTION_FOR_CUSTOMER_TYPE_DISCOUNT_FORMPRODUCT_OPTION_FOR_CART_ADD_ITEM_FORMPRODUCT_DISCOUNT_CREATEPRODUCT_DISCOUNT_UPDATEPRODUCT_DISCOUNT_DELETEPRODUCT_RECEIVE_CREATEPRODUCT_RECEIVE_UPLOADPRODUCT_RECEIVE_ADD_ITEMPRODUCT_RECEIVE_ADD_IMAGEPRODUCT_RECEIVE_UPDATEPRODUCT_RECEIVE_CANCELPRODUCT_RECEIVE_MARK_COMPLETEPRODUCT_RECEIVE_FETCHPRODUCT_RECEIVE_GETPRODUCT_RECEIVE_DELETEPRODUCT_RECEIVE_DELETE_ITEMPRODUCT_RECEIVE_DELETE_IMAGEPRODUCT_STOCK_FETCHPRODUCT_STOCK_GETPRODUCT_STOCK_DOWNLOAD_REPORTPRODUCT_STOCK_ADJUSTMENTPRODUCT_UNIT_CREATEPRODUCT_UNIT_GETPRODUCT_UNIT_UPDATEPRODUCT_UNIT_DELETEPRODUCT_UNIT_OPTION_FOR_PRODUCT_RECEIVE_ITEM_FORMPRODUCT_UNIT_OPTION_FOR_DELIVERY_ORDER_ITEM_FORMROLE_OPTION_FOR_USER_FORMSHOP_ORDER_FETCHSHOP_ORDER_GETSSR_WHATSAPP_LOGINSUPPLIER_CREATESUPPLIER_FETCHSUPPLIER_GETSUPPLIER_UPDATESUPPLIER_DELETESUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FORMSUPPLIER_OPTION_FOR_PRODUCT_RECEIVE_FILTERSUPPLIER_TYPE_CREATESUPPLIER_TYPE_FETCHSUPPLIER_TYPE_GETSUPPLIER_TYPE_UPDATESUPPLIER_TYPE_DELETESUPPLIER_TYPE_OPTION_FOR_SUPPLIER_FORMTIKTOK_PRODUCT_CREATETIKTOK_PRODUCT_UPLOAD_IMAGETIKTOK_PRODUCT_FETCH_BRANDSTIKTOK_PRODUCT_FETCH_CATEGORIESTIKTOK_PRODUCT_GET_RULESTIKTOK_PRODUCT_GET_CATEGORY_ATTRIBUTESTIKTOK_PRODUCT_GETTIKTOK_PRODUCT_UPDATETIKTOK_PRODUCT_RECOMMENDED_CATEGORYTIKTOK_PRODUCT_RECOMMENDED_ACTIVATETIKTOK_PRODUCT_RECOMMENDED_DEACTIVATETRANSACTION_CHECKOUT_CARTTRANSACTION_GETUSER_CREATEUSER_FETCHUSER_GETUSER_UPDATEUSER_UPDATE_PASSWORDUSER_UPDATE_ACTIVEUSER_UPDATE_INACTIVEUSER_ADD_ROLEUSER_DELETE_ROLEUSER_OPTION_FOR_CASHIER_SESSION_FILTERUSER_OPTION_FOR_DELIVERY_ORDER_DRIVER_FORMUNIT_CREATEUNIT_FETCHUNIT_GETUNIT_UPDATEUNIT_DELETEUNIT_OPTION_FOR_PRODUCT_UNIT_FORMUNIT_OPTION_FOR_PRODUCT_UNIT_TO_UNIT_FORMWHATSAPP_IS_LOGGED_INWHATSAPP_PRODUCT_PRICE_CHANGE_BROADCASTWHATSAPP_CUSTOMER_TYPE_DISCOUNT_BROADCASTWHATSAPP_LOGOUT"

var _Permission_index = [...]uint16{0, 14, 27, 38, 52, 66, 81, 94, 110, 126, 141, 159, 170, 191, 212, 231, 264, 295, 322, 341, 356, 370, 382, 397, 412, 451, 492, 518, 537, 554, 575, 595, 614, 631, 651, 671, 697, 726, 755, 793, 862, 879, 889, 897, 909, 930, 951, 974, 998, 1023, 1043, 1070, 1088, 1120, 1147, 1172, 1193, 1214, 1243, 1275, 1296, 1322, 1349, 1377, 1404, 1429, 1443, 1457, 1470, 1481, 1495, 1509, 1553, 1596, 1642, 1679, 1702, 1725, 1748, 1770, 1792, 1816, 1841, 1863, 1885, 1914, 1935, 1954, 1976, 2003, 2031, 2050, 2067, 2096, 2120, 2139, 2155, 2174, 2193, 2242, 2290, 2315, 2331, 2345, 2363, 2378, 2392, 2404, 2419, 2434, 2474, 2516, 2536, 2555, 2572, 2592, 2612, 2650, 2671, 2698, 2725, 2756, 2780, 2818, 2836, 2857, 2892, 2927, 2964, 2989, 3004, 3015, 3025, 3033, 3044, 3064, 3082, 3102, 3115, 3131, 3169, 3211, 3222, 3232, 3240, 3251, 3262, 3295, 3336, 3357, 3396, 3437, 3452}
