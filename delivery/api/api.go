...
func registerRoutes(router gin.IRouter, useCaseManager use_case.UseCaseManager) {
	...
	RegisterCashierSessionApi(router, useCaseManager)
	RegisterCustomerApi(router, useCaseManager)
	RegisterCustomerDebtApi(router, useCaseManager)
	RegisterCustomerTypeApi(router, useCaseManager)
	RegisterCustomerTypeDiscountApi(router, useCaseManager)
	RegisterDashboardApi(router, useCaseManager)
	RegisterDebtApi(router, useCaseManager)
	RegisterDeliveryOrderApi(router, useCaseManager)
	RegisterDeliveryOrderReviewApi(router, useCaseManager)
	RegisterProductApi(router, useCaseManager)
	RegisterProductDiscountApi(router, useCaseManager)
	RegisterProductUnitApi(router, useCaseManager)
	RegisterProductReceiveApi(router, useCaseManager)
	RegisterProductReturnApi(router, useCaseManager)
	RegisterProductStockAdjustmentApi(router, useCaseManager)
	RegisterProductStockApi(router, useCaseManager)
	RegisterPurchaseOrderApi(router, useCaseManager)
	RegisterRoleApi(router, useCaseManager)
	RegisterShopOrderApi(router, useCaseManager)
