...
func RegisterIdTranslations(v *validator.Validate, trans ut.Translator) (err error) {
	translations := []translation{
		...
		{
			tag:         "alphanumdot",
			translation: "{0} hanya dapat berisi karakter alfanumerik dan titik",
			override:    false,
		},
		{
			tag:         "alphanumdash",
			translation: "{0} hanya dapat berisi karakter alfanumerik dan garis penghubung",
			override:    false,
		},
		{
			tag:         "alphanumdashdotslash",
			translation: "{0} hanya dapat berisi karakter alfanumerik, garis penghubung, titik dan garis miring depan",
			override:    false,
		},
		{
			tag:         "not_empty",
		...
		},
		{
			...
			translation: "{0} harus bernilai array string",
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				var t string
				var err error
