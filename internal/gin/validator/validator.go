...
func (ve StructValidationErrors) extractDomain(err validator.FieldError) string {
	...
	case "pagination_request.page":
		domain = "page"
	case "hba_1_c_percentage":
		domain = "hba1c_percentage"
	}
...
func (v *defaultValidator) lazyinit() {
	v.once.Do(func() {
		...
		v.validate.RegisterStructValidation(data_type.ArrayStringValidationFn, data_type.ArrayString{})
		...
		// 	dto_request.RequestValidationFn,
		// 	dto_request.StructRequest{},
		// )
