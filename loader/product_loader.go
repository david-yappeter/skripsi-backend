...
func (l *ProductLoader) ProductUnitFn(productUnit *model.ProductUnit) func() error {
	return func() error {
		product, err := l.loadById(productUnit.ProductId)
		if err != nil {
			return err
		}
...
func (l *ProductLoader) CustomerTypeDiscountFn(customerTypeDiscount *model.CustomerTypeDiscount) func() error {
	return func() error {
		product, err := l.loadById(customerTypeDiscount.ProductId)
		if err != nil {
			return err
		}

		customerTypeDiscount.Product = product
